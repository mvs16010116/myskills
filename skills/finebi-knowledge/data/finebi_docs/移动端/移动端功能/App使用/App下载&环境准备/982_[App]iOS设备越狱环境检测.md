...
doc_id: 982
url: https://help.fanruan.com/finebi6.X/doc-view-982.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:12:08
---
...
## 3\. 打包 App
[用户自定义打包](<https://help.fanruan.com/finebi6.0/doc-view-344.html>) 的 App，默认检测 iOS 设备是否越狱。对于越狱设备，弹出提示框：当前设备已越狱，无法使用。
点击确定退出 App。如下图所示：
![image.png](/core/style/lod.png)
### 附件列表 
...
[![](/core/style/back.png)上一篇：[App]虚拟网设置](<index.php?doc-view-959.html>)
[下一篇：[App]消息 ![](/core/style/forward.png) ](<index.php?doc-view-794.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
