...
doc_id: 452
url: https://help.fanruan.com/finebi6.X/doc-view-452.html
source: FineBI 帮助文档
...
安装插件方法参照：[插件管理](<https://help.fanruan.com/finebi6.X/doc-view-459.html> "插件管理")
![](/core/style/lod.png)  
...
单张仪表板| 预览链接  
| 获取到 [仪表板预览](<https://help.fanruan.com/finebi6.X/doc-view-159.html>) 链接直接移动端访问即可http://ip:端口号/webroot/decision/v5/design/report/此处放置仪表板ID/view  
公共链接| 获取到[公共链接](<https://help.fanruan.com/finebi6.X/doc-view-164.html>)直接移动端访问即可  
给出一些示例：
**1）登录页面**
PC端FineBI的链接为：http://localhost:37799/webroot/decision
移动端访问时链接需修改为：http://172.16.2.134:37799/webroot/decision
![Screenshot_20220930_134656_com.tencent.wework.jpg](/core/style/lod.png)
**2）目录页面**
...
![Screenshot_20220930_134920_com.tencent.wework.jpg](/core/style/lod.png)
**3）访问单张仪表板**
...
![Snag_4d2db469.png](/core/style/lod.png)
...
![Snag_4d47c245.png](/core/style/lod.png)
示例：
...
解决方案就是改变浏览器的窗口大小。
![1608688335752161.png](/core/style/lod.png)
### 4.2 仪表板无法查看提示该模板已被删除
**报错详情：**
在电脑端做的仪表板，手机端无法查看，显示「该模板已被删除」。
**解决方案：**
没有注册 lic 。关于注册步骤，详情请参考：[本地机器信息认证](<https://help.fanruan.com/finebi6.0/doc-view-188.html>) 。
### 附件列表 
  
下载次数：：0
    
**主题：** [移动端](<category-view-102>)
[![](/core/style/back.png)上一篇：移动端功能点说明](<index.php?doc-view-552.html>)
[下一篇：App端如何访问FineBI ![](/core/style/forward.png) ](<index.php?doc-view-346.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
