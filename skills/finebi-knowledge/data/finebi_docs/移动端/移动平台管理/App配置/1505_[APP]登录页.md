...
title: [APP]登录页
doc_id: 1505
url: https://help.fanruan.com/finebi6.X/doc-view-1505.html
source: FineBI 帮助文档
...
注2：暂不支持 APP 登录页面国际化。
![登陆设置11111.png](/core/style/lod.png)
## 2\. 内置登录页
默认情况下是「内置登录页」。登录 App 时的效果如下图所示：
![Screenshot_20210707_141120_com.finereact.v10\(1\).jpg](/core/style/lod.png)
管理员登录FineBI系统，打开「管理系统>移动平台>APP配置」，「登录设置」中「登录方式」选择「内置登录页」并「保存」，成功设置为内置登录页。如下图所示：  

![登陆设置2222.png](/core/style/lod.png)
## 3\. 自定义登录网页
用户的场景需求多样，如：  
...
![企业微信截图_35363d9b-3430-4825-9b3b-c2e4dca3c192.png](/core/style/lod.png)
### 3.1 新建文件
首先，用户需要自定义登录页面。
...
![2021-07-07_18-45-51.png](/core/style/lod.png)
### 3.3 设置自定义登录网页
...
[![](/core/style/back.png)上一篇：全屏按钮设置](<index.php?doc-view-1345.html>)
[下一篇：移动端设备绑定与撤销 ![](/core/style/forward.png) ](<index.php?doc-view-343.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
