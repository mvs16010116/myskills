...
title: 加速引擎
doc_id: 2258
url: https://help.fanruan.com/finebi6.X/doc-view-2258.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:09:44
---
...
* 历史版本：[16](<edition-list-2258.html>)
* 最近更新：[Lily.Wang](<user-space-337243.html>) 于 2025-01-20 
...
2）连接成功后，用户可以直接「复制数据连接 URL」，去「数据连接」中，输入该加速库的信息再新建一个数据连接。详情请参见：[StarRocks 数据连接](<https://help.fanruan.com/finebi6.X/doc-view-2038.html>)
...
![](/core/style/lod.png)
1）例如，我们筛选查询时间超过 10s 的 SQL。其中有一个耗时 57 秒的，我们可以双击「仪表板id、组件id、数据集id」后右键复制 id。再去「BI工具>查询>表名查询」中依据 ID 找到对应的数据表，或者去 [配置数据集](<https://help.fanruan.com/finebi6.X/doc-view-2149.html>) 中依据 ID 找到具体的仪表板、组件和数据集。
![](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：智能运维](<index.php?doc-view-178.html>)
[下一篇：排序查询加速 ![](/core/style/forward.png) ](<index.php?doc-view-2492.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
