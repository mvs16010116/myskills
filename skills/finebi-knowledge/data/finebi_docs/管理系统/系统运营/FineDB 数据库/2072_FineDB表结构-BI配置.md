---
title: FineDB表结构-BI配置
doc_id: 2072
url: https://help.fanruan.com/finebi6.X/doc-view-2072.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:10:16
---

> 1. 概述1.1 版本FineBI服务器版本功能变更6.1-1.2 功能简介为了方便管理员对FineBI中的数据、组件、仪表板、主题、公共数据进行管理，FineBI6的finedb数据库中，新增了一系列
...
Report_Tables_Map| 仪表板表的映射关系，表示仪表板中控件使用了哪些表  
...
[![](/core/style/back.png)上一篇：FineDB 表结构](<index.php?doc-view-819.html>)
[下一篇：BI系统配置数据集 ![](/core/style/forward.png) ](<index.php?doc-view-2149.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
