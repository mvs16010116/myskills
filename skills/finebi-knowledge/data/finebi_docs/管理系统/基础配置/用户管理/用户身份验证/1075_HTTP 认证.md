...
title: HTTP 认证
doc_id: 1075
url: https://help.fanruan.com/finebi6.X/doc-view-1075.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:08:24
---
...
[/code]
![1601256530740460.png](/core/style/lod.png)
认证地址为：http://0.0.0.0:3000/
### 2.3 获取公钥
服务器启动成功后，打开 Node 文件夹下的 key.txt，复制公钥，如下图所示：
![1597029969779549.png](/core/style/lod.png)
### 2.4 决策平台开启 HTTP 认证
...
注：确保本地有 Java 环境。
![1601258519647659.png](/core/style/lod.png)
#### 3.2.3 复制公钥  

1）服务器启动成功后，打开 key.txt，复制 publickey ，如下图所示：
![1600826506450973.png](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：LDAP 认证](<index.php?doc-view-1058.html>)
[下一篇：多域LDAP认证 ![](/core/style/forward.png) ](<index.php?doc-view-1188.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
