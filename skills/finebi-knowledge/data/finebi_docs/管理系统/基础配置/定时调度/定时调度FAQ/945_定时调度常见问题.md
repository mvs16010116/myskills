...
title: 定时调度常见问题
doc_id: 945
url: https://help.fanruan.com/finebi6.X/doc-view-945.html
source: FineBI 帮助文档
...
重启服务器后设置生效。
注：修改 FineDB 数据库表字段值的方法请参考 [fine_conf_entity可视化配置](<https://help.fanruan.com/finebi6.X/doc-view-1235.html>) 。
配置项| 含义| 修改规则  
---|---|---  
...
重启服务器后设置生效。
注：修改 FineDB 数据库表字段值的方法请参考 [FINE_CONF_ENTITY可视化配置](<https://help.fanruan.com/finebi6.0/doc-view-1235.html>) 。
配置项| 含义| 修改规则  
---|---|---  
...
![1592883862705345.png](/core/style/lod.png)
**原因分析：**
...
发件人的地址或密码不正确。
**解决方案：**
请参考「[邮箱](<https://help.fanruan.com/finebi6.X/doc-view-1257.html>)」中的配置步骤，核对邮箱发件人配置。
...
**解决方案：**
关闭所有 [模板限制](<https://help.fanruan.com/finebi6.0/doc-view-1220.html?source=1#9>)
...
[![](/core/style/back.png)上一篇：定时调度邮件通知](<index.php?doc-view-719.html>)
[下一篇：定时调度时区异常提示 ![](/core/style/forward.png) ](<index.php?doc-view-1348.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
