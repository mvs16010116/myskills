...
doc_id: 2074
url: https://help.fanruan.com/finebi6.X/doc-view-2074.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:09:15
---

> 1.&nbsp;概述1.1&nbsp;版本FineBI服务器版本功能变更6.0-1.2 应用场景FineBI 在定时调度中提供了自定义类判断功能。用户可以根据业务需要自己编写自定义类，然后交给系统执行，
...
* 历史版本：[6](<edition-list-2074.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2024-03-13 
...
注2：编译环境准备和编译 Java 文件的详细步骤请参见：[编译Java程序](<https://help.fanruan.com/finereport/doc-view-744.html#3>)。
### 2.2 仪表板准备
#### 2.2.1 复制模板链接
...
Lisa（Lisa，1）登录 [FineMobile 数据分析 App](<https://help.fanruan.com/finebi6.0/doc-view-346.html>)，收到一条新消息。如下图所示：  
...
[![](/core/style/back.png)上一篇：定时任务执行条件之公式判断](<index.php?doc-view-993.html>)
[下一篇：定时调度支持的公式 ![](/core/style/forward.png) ](<index.php?doc-view-749.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
