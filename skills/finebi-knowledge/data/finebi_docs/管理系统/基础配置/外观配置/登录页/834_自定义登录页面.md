...
title: 自定义登录页面
doc_id: 834
url: https://help.fanruan.com/finebi6.X/doc-view-834.html
source: FineBI 帮助文档
...
* 历史版本：[12](<edition-list-834.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2024-02-05 
...
## 3\. 开启模板认证后访问仪表板
使用自定义登录界面，开启 [模板认证](<https://help.fanruan.com/finebi6.0/doc-view-403.html>) ，访问单张仪表板，跳转到自定义登录界面登录成功后，可查看仪表板。
**示例：**
设置自定义登录界面并开启 [用户名密码认证](<https://help.fanruan.com/finebi6.0/doc-view-404.html>) ，仪表板预览链接为：http://localhost:37799/webroot/decision/v5/design/report/6c92aa9694204baa838cadf0e0a9d551/view，另一用户访问仪表板 URL ，效果如下图所示：
...
[![](/core/style/back.png)上一篇：登录页](<index.php?doc-view-986.html>)
[下一篇：还原登录页设置 ![](/core/style/forward.png) ](<index.php?doc-view-1259.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
