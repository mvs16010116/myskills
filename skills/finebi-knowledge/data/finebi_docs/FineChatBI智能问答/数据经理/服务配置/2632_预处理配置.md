...
title: 预处理配置
doc_id: 2632
url: https://help.fanruan.com/finebi6.X/doc-view-2632.html
source: FineBI 帮助文档
...
* 历史版本：[11](<edition-list-2632.html>)
* 最近更新：[Lily.Wang](<user-space-337243.html>) 于 2025-08-21 
...
| 预处理识别意图（示例）  
---|---  
毛利率计算公式| 通过预处理自动识别为：问知识注：需已配置企业知识库 [知识库问答配置](<https://help.fanruan.com/finebi6.X/doc-view-2631.html>)  
...
![1747384310101836.png](/core/style/lod.png)
## 2\. 预处理配置
### 2.1 接口概览
  * 请求方式：POST
  * 接口地址：企业自定义的接口地址
...
[![](/core/style/back.png)上一篇：知识库问答配置](<index.php?doc-view-2631.html>)
[下一篇：大模型配置 ![](/core/style/forward.png) ](<index.php?doc-view-2633.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
