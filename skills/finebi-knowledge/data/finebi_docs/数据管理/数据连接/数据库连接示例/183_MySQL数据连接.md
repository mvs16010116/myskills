...
title: MySQL数据连接
doc_id: 183
url: https://help.fanruan.com/finebi6.X/doc-view-183.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:06
---
...
![1589868788448436.jpg](/core/style/lod.png)
### 5.2 添加数据表问题
#### 5.2.1 SQL 语句  
...
#### 5.2.2 字段类型
1）当使用 MYSQL 数据连接并添加数据表时，若数据库版本为 MYSQL 5.6 ，请确保数据库中 varchar 文本类型字段不为空，否则添加表至 BI 后出现小方块![1574922930783691.png](/core/style/lod.png)乱码。
...
[![](/core/style/back.png)上一篇：Trino 数据连接](<index.php?doc-view-2000.html>)
[下一篇：IBM DB2数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-98.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
