...
title: Doris数据连接
doc_id: 1688
url: https://help.fanruan.com/finebi6.X/doc-view-1688.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:22
---

> 1. 概述1.1 版本FineBI 版本功能变动6.0-1.2 应用场景本文将介绍如何 FineBI 如何连接 Doris 数据库。2. 连接前准备2.1 数据库版本和驱动驱动支持的数据库版本com.m
...
| 支持的数据库版本  
---|---  
com.mysql.jdbc.Driver（已内置）| Baidu Doris version 0.14.7-867d3de  
...
[![](/core/style/back.png)上一篇：FusionInsight elk数据连接](<index.php?doc-view-299.html>)
[下一篇：Hadoop Hive数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-301.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
