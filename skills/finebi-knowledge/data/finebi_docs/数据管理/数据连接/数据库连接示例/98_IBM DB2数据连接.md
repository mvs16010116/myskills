...
title: IBM DB2数据连接
doc_id: 98
url: https://help.fanruan.com/finebi6.X/doc-view-98.html
source: FineBI 帮助文档
...
[![](/core/style/back.png)上一篇：MySQL数据连接](<index.php?doc-view-183.html>)
[下一篇：Pivotal Greenplum Database数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-289.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
