...
title: INFORMIX数据连接
doc_id: 99
url: https://help.fanruan.com/finebi6.X/doc-view-99.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:09
---
...
## 2\. 准备工作
### 2.1 版本和驱动
下载驱动包，并将其上传至 FineBI 中，如何上传详情可参见：[驱动管理](<https://help.fanruan.com/finebi6.0/doc-view-1540.html?source=4>)
支持的| 驱动下载   
---|---  
V11.7、V11.5  
...
[![](/core/style/back.png)上一篇：达梦数据连接](<index.php?doc-view-1712.html>)
[下一篇：Apache Phoenix数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-294.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
