...
title: Oracle 数据连接
doc_id: 185
url: https://help.fanruan.com/finebi6.X/doc-view-185.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:16
---
...
Oracle 9.2.0 / 9iOracle 10.1Oracle 10.2 / 10g-R2| [ojdbc14.jar](<doc-download-/finebi5.1/uploads/file/20220105/ojdbc14.jar> "下载资料")上传驱动包的具体步骤可参见：[驱动管理](<https://help.fanruan.com/finebi6.X/doc-view-1540.html>)  
### 2.2 收集连接信息
在连接数据库之前，请收集以下信息：
  * 数据库所在服务器的 IP 地址和端口号；
  * 数据库的名称；
...
![1613723315446537.png](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：DERBY数据连接](<index.php?doc-view-96.html>)
[下一篇：Amazon Redshift数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-292.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
