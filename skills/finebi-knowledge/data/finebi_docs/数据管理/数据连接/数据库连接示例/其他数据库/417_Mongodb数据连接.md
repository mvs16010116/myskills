...
title: Mongodb数据连接
doc_id: 417
url: https://help.fanruan.com/finebi6.X/doc-view-417.html
source: FineBI 帮助文档
...
## 2\. 操作步骤
1）[远程连接 FineReport 设计器](<https://help.fanruan.com/finebi6.0/doc-view-931.html>)；
2）在 [FineReport 连接 MongoDB](<http://help.finereport.com/doc-view-1413.html>)；
3）创建 MongoDB 数据集并通过[服务器数据集](<https://help.fanruan.com/finebi6.0/doc-view-253.html>)将其添加至 BI 中使用；
## 3\. 注意事项
...
[![](/core/style/back.png)上一篇：新SAP BW数据集插件](<index.php?doc-view-256.html>)
[下一篇：通用数据连接常见问题 ![](/core/style/forward.png) ](<index.php?doc-view-760.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
