...
doc_id: 282
url: https://help.fanruan.com/finebi6.X/doc-view-282.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:06:58
---
...
* 历史版本：[41](<edition-list-282.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2024-08-20 
...
![1574066211785589.png](/core/style/lod.png)
### 2.2 设置数据连接
1）参考 [Kerberos 驱动整理](<https://help.fanruan.com/finebi6.X/doc-view-1973.html>) 找到对应驱动，更改 URL 为对应格式，切换认证方式为 Kerberos。如下图所示：
...
[![](/core/style/back.png)上一篇：StarRocks 数据连接](<index.php?doc-view-2038.html>)
[下一篇：Kerberos 驱动整理 ![](/core/style/forward.png) ](<index.php?doc-view-1973.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
