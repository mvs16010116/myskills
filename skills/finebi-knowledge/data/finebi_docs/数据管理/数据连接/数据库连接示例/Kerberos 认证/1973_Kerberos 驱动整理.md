...
title: Kerberos 驱动整理
doc_id: 1973
url: https://help.fanruan.com/finebi6.X/doc-view-1973.html
source: FineBI 帮助文档
...
[![](/core/style/back.png)上一篇：数据连接 Kerberos 认证](<index.php?doc-view-282.html>)
[下一篇：HSQL数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-1710.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
