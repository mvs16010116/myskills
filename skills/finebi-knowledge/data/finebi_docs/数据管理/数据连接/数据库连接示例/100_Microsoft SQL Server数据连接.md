...
doc_id: 100
url: https://help.fanruan.com/finebi6.X/doc-view-100.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:12
---
...
* 历史版本：[28](<edition-list-100.html>)
* 最近更新：[Lily.Wang](<user-space-337243.html>) 于 2025-08-12 
...
## 2\. 准备工作
### 2.1 版本和驱动
下载对应的驱动包，如何上传驱动包可参见：[驱动管理](<https://help.fanruan.com/finebi6.0/doc-view-1540.html?source=4>)  

支持的数据库版本| 驱动包下载   
---|---  
SQL Server 2000  
|  [jtds驱动](<https://fine-build.oss-cn-shanghai.aliyuncs.com/hw/driver/jtds-1.3.1.jar>)，操作方式可参见：[jtds驱动连接方式](<https://help.fanruan.com/finereport/doc-view-306.html#cba52e90bb7429d4>)  
SQL Server 2005  
SQL Server 2008SQL Server 2012SQL Server 2014SQL Server 2016SQL Server 2017SQL Server 2019| 可以直接使用内置驱动更建议依据用户自己的数据库版本，前往官网选择合适的驱动：[sql server支持矩阵](<https://learn.microsoft.com/zh-cn/sql/connect/jdbc/microsoft-jdbc-driver-for-sql-server-support-matrix?view=sql-server-ver16>)  
### 2.2 收集连接信息
在连接数据库之前，请收集以下信息：
  * 数据库所在服务器的 IP 地址和端口号；
  * 数据库的名称；
...
[![](/core/style/back.png)上一篇：ClickHouse 数据连接](<index.php?doc-view-1102.html>)
[下一篇：阿里云AnalyticDB数据连接 ![](/core/style/forward.png) ](<index.php?doc-view-291.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
