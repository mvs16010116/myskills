...
title: MySQL数据连接常见问题
doc_id: 2117
url: https://help.fanruan.com/finebi6.X/doc-view-2117.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:34
---
...
* 最近更新：[Carly](<user-space-222366.html>) 于 2025-07-25 
...
6.0  
### 1.2 应用场景
本文介绍 [MySQL数据连接](<https://help.fanruan.com/finebi6.X/doc-view-183.html>) 中，常见的问题及排查步骤。
## 2\. 数据乱码
**问题描述：**
...
**解决方案：**
服务器字体安装请参见：[服务器安装字体](<https://help.fanruan.com/finebi6.X/doc-view-1382.html>)。
...
请参考 [MySQL数据连接](<https://help.fanruan.com/finebi6.X/doc-view-183.html>) 修改数据连接URL格式。
### 3.2 驱动版本不匹配
**原因分析：**
工程中使用的MySQL驱动版本，与数据连接的MySQL数据库版本不匹配。
**解决方案：**
请参考 [MySQL数据连接](<https://help.fanruan.com/finebi6.X/doc-view-183.html>) 获取匹配版本的驱动并上传到工程中。
...
**解决方案：**
从 [MySQL官网](<https://downloads.mysql.com/archives/c-j/>) 下载 MySQL 8.X 版本的驱动，并将其上传至 FineReport，如何上传可参见：[驱动管理](<https://help.fanruan.com/finebi6.X/doc-view-1540.html>) 2.1 节。
...
**原因分析：**
MySQL 数据库写超时时间配置过短，默认为60s，当连接持续写入超过设置值时会被 MySQL 服务器断开。
**排查步骤：**
...
[![](/core/style/back.png)上一篇：通用数据连接常见问题](<index.php?doc-view-760.html>)
[下一篇：Oracle 数据连接常见错误解决方案 ![](/core/style/forward.png) ](<index.php?doc-view-1100.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
