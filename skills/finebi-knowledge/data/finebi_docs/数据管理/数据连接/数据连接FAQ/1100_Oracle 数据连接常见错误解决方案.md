...
doc_id: 1100
url: https://help.fanruan.com/finebi6.X/doc-view-1100.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:35
---
...
* 历史版本：[8](<edition-list-1100.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2023-09-15 
[](<javascript:;>) [](<javascript:>)
## 1\. 概述
本文介绍 [Oracle 数据连接](<https://help.fanruan.com/finebi6.0/doc-view-185.html>) 中一些报错及解决方案。
...
**解决方案：**
修改连接池，扩大连接池最大连接个数，修改方法详见 [配置数据连接](<https://help.fanruan.com/finebi6.X/doc-view-94.html> "连接池属性") 中 4.2 节高级设置。
## 5\. 数据乱码
**问题描述：**
1）Oracle 数据预览时，数据乱码，日期错乱。
2）Oracle 数据连接，[添加 DB 表](<https://help.fanruan.com/finebi6.0/doc-view-887.html>) 时，表名/表头乱码。
### 5.1 数据库编码格式不一致
**原因分析：**  
...
### 5.2 数据库驱动不一致
不同数据库版本使用的驱动是有很大差别的。
请务必参考 [Oracle 数据连接](<https://help.fanruan.com/finebi6.0/doc-view-185.html>) 选择适合自己数据库版本的驱动。
...
![1603179045829725.png](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：MySQL数据连接常见问题](<index.php?doc-view-2117.html>)
[下一篇：SQL Server数据连接常见问题 ![](/core/style/forward.png) ](<index.php?doc-view-2119.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
