...
title: 【直连】缓存设置
doc_id: 1669
url: https://help.fanruan.com/finebi6.X/doc-view-1669.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:48
---

> 1. 概述1.1 版本&nbsp;FineBI 版本功能变动6.0-1.2 应用场景FineBI 直连属性的表，默认每隔 600 秒清除一次缓存重新发 SQL 给数据库获取最新数据，所以是 600 秒刷
...
### 1.3 功能简介
  * 缓存设置是直连版本特有功能。
  * 本文介绍如何对单张表设置缓存，如果想对全局设置缓存，可参见 [缓存](<https://help.fanruan.com/finebi6.0/doc-view-1674.html>) 。  

  * 只有有数据表管理权限的人可以进行「缓存设置」，详情请参见：[数据权限](<https://help.fanruan.com/finebi6.0/doc-view-248.html>)
...
若要修改全局缓存时间，可修改 [BI/Spider参数](<https://help.fanruan.com/finebi6.0/doc-view-312.html>) 中的「缓存时间」参数。
![](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：更新信息](<index.php?doc-view-79.html>)
[下一篇：多路径简介 ![](/core/style/forward.png) ](<index.php?doc-view-80.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
