...
title: Excel 上传失败
doc_id: 830
url: https://help.fanruan.com/finebi6.X/doc-view-830.html
source: FineBI 帮助文档
...
### 2.1 问题描述
集群环境下，导入大数据量 Excel 时出现上传失败弹窗，如下图所示：
![132.png](/core/style/lod.png)
### 2.2 原因分析
...
[![](/core/style/back.png)上一篇：上传 Excel 能被正确识别的字段类型](<index.php?doc-view-628.html>)
[下一篇：Excel 数据集常见问题 ![](/core/style/forward.png) ](<index.php?doc-view-831.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
