...
title: 数据更新报错
doc_id: 613
url: https://help.fanruan.com/finebi6.X/doc-view-613.html
source: FineBI 帮助文档
...
**原因分析**
Linux 中存储数据的文件夹没有读写权限。存储的文件夹和路径可在「数据准备>更新设置」中看到，详细请参见：[数据更新与存放](<https://help.fanruan.com/finebi6.0/doc-view-383.html?source=1>)  
...
**解决办法**
调大内存化参数。参见文档：[BI/Spider参数](<https://help.fanruan.com/finebi6.0/doc-view-312.html>)
## 15\. Table info lost
**解决办法**
...
## 20\. 打开的文件过多
**解决方案**
参考文档：[Linux最大打开文件数](<https://help.fanruan.com/finebi6.0/doc-view-28.html>)
...
[![](/core/style/back.png)上一篇：数据存放路径](<index.php?doc-view-383.html>)
[下一篇：更新慢排查帮助 ![](/core/style/forward.png) ](<index.php?doc-view-1156.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
