...
title: 更新Excel
doc_id: 331
url: https://help.fanruan.com/finebi6.X/doc-view-331.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:51
---

> 1. 概述1.1 版本FineBI 版本新增内容6.0-1.2 应用场景用户需要对 Excel 进行更新的时候，可以使用「更新 Excel」功能。1.3 功能介绍支持「追加数据」与「替换数据」的操作。追
...
注2：Excel 数据集不支持实时更新。
## 2\. 操作步骤
1）进入「公共数据」，选择你要更新的 Excel 数据集，点击「更新excel」按钮，如下图所示：
...
[![](/core/style/back.png)上一篇：基础表单表更新](<index.php?doc-view-90.html>)
[下一篇：自助数据集单表更新 ![](/core/style/forward.png) ](<index.php?doc-view-1498.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
