...
doc_id: 2301
url: https://help.fanruan.com/finebi6.X/doc-view-2301.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:07:40
---

> 1. 概述1.1 版本FineBI 版本功能变更6.0.14~6.0.X-6.1.5~6.1.X-1.2 功能场景BI Rest API数据集支持FineBI对接WEB API进行取数对接第三方的WEB
...
* 历史版本：[11](<edition-list-2301.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2026-03-18 
...
BI Rest API数据集支持FineBI对接WEB API进行取数
  * 对接第三方的WEB API进行取数
  * 通过JSON解析返回的数据
  * **直连数据集支持直连传递参数调用 第三方的WEB API**


### 1.3 注意事项
1）Rest API数据集不支持增量更新的方式。
## 2\. 插件介绍
### 2.1 插件安装
...
![](/core/style/lod.png)
**API认证：** 支持的认证方式：无认证、Basic Auth、Bearer Token、其他认证(自定义Token)
![](/core/style/lod.png)
**请求头** ：添加请求头参数
![](/core/style/lod.png)
**请求体：** 只有在POST请求方式下，才需要配置Body
表单方式支持：form-data与x-www-form-urlencoded
...
[![](/core/style/back.png)上一篇：公共数据集概述](<index.php?doc-view-43.html>)
[下一篇：添加数据库表 ![](/core/style/forward.png) ](<index.php?doc-view-887.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
