...
title: FORMAT-格式转换
doc_id: 1454
url: https://help.fanruan.com/finebi6.X/doc-view-1454.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:04:09
---
...
## 2\. 注意事项
  ...
  * [[直连]Kyligence企业版](<https://help.fanruan.com/finebi6.0/doc-view-1169.html>) 数据库不支持该函数。
...
![2022-08-30_15-50-09.png](/core/style/lod.png)
### 3.2 数值格式参数
以 1234.56 为例。  
...
[![](/core/style/back.png)上一篇：INDEXOF-返回指定位置的字符](<index.php?doc-view-1467.html>)
[下一篇：FIND-返回字符所在位置 ![](/core/style/forward.png) ](<index.php?doc-view-1468.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
