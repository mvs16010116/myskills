...
doc_id: 1469
url: https://help.fanruan.com/finebi6.X/doc-view-1469.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:04:02
---
...
**
![](/core/style/lod.png)
添加[ 计算字段](<https://help.fanruan.com/finebi6.0/doc-view-118.html>)，输入公式：REPLACE(客户名称,"有限","股份")，如下图所示：
![](/core/style/lod.png)
更多示例：
公式| 结果| 备注  
---|---|---  
...
[![](/core/style/back.png)上一篇：RIGHT-截取后几个字符串](<index.php?doc-view-1465.html>)
[下一篇：REPEAT-重复显示文本 ![](/core/style/forward.png) ](<index.php?doc-view-1462.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
