...
doc_id: 1476
url: https://help.fanruan.com/finebi6.X/doc-view-1476.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:04:03
---
...
![1623297122X6d4.png](/core/style/lod.png)
  

更多正则表达式示例详情参见：[正则表达式示例](<https://help.fanruan.com/finebi6.0/doc-view-1155.html>)
### 1.2 用法二
**1）概述**
...
![1623297137YJXx.png](/core/style/lod.png)
## 2\. 直连版本
**1）概述**
...
[SAP Sybase](<https://help.fanruan.com/finebi6.0/doc-view-307.html>) 数据库和 [Microsoft SQL Server](<https://help.fanruan.com/finebi6.0/doc-view-100.html>) 数据库不支持该函数。
**3）示例**
公式| 结果| 备注  
---|---|---  
REGEXP("aaaaac","a*c")| true|   
...
[![](/core/style/back.png)上一篇：REPEAT-重复显示文本](<index.php?doc-view-1462.html>)
[下一篇：PROPER-转换文本大小写 ![](/core/style/forward.png) ](<index.php?doc-view-1475.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
