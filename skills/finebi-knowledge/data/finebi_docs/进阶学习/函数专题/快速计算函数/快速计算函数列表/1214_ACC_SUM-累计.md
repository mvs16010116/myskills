...
title: ACC_SUM-累计
doc_id: 1214
url: https://help.fanruan.com/finebi6.X/doc-view-1214.html
source: FineBI 帮助文档
...
---|---|---  
参数1| x_agg(array)| 第一个参数为用户计算的指标，该指标必须为 [聚合函数](<https://help.fanruan.com/finebi6.0/doc-view-4.html>) 或聚合指标。  
...
![](/core/style/lod.png)
## 4\. 拓展阅读
[累计值（快速计算）](<https://help.fanruan.com/finebi6.0/doc-view-1680.html>)
...
[![](/core/style/back.png)上一篇：快速计算函数概述](<index.php?doc-view-1499.html>)
[下一篇：PERIOD_ANLS-上期末 ![](/core/style/forward.png) ](<index.php?doc-view-1210.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
