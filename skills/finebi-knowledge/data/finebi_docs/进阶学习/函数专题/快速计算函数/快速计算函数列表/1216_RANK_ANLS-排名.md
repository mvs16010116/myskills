...
title: RANK_ANLS-排名
doc_id: 1216
url: https://help.fanruan.com/finebi6.X/doc-view-1216.html
source: FineBI 帮助文档
...
* 历史版本：[12](<edition-list-1216.html>)
...
---|---|---  
参数1| x_agg(array)| 第一个参数为用户计算的指标，该指标必须为聚合函数或聚合指标。聚合指标即使用[聚合函数](<https://help.fanruan.com/finebi6.0/doc-view-4.html>)计算得到的结果  
...
### 3.1 计算地区合同金额排名
新增 [计算字段](<https://help.fanruan.com/finebi6.0/doc-view-118.html>)，命名为「排名」字段，输入公式：RANK_ANLS(SUM_AGG(合同金额),0,"asc")，如下图所示：
![](/core/style/lod.png)
...
![](/core/style/lod.png)
## 4\. 拓展阅读
[排名（快速计算）](<https://help.fanruan.com/finebi6.0/doc-view-1678.html>)
### 附件列表 
  
下载次数：：0
    
**主题：** [进阶学习](<category-view-254>)
[![](/core/style/back.png)上一篇：PREVIOUS_PERIOD-环期](<index.php?doc-view-1213.html>)
[下一篇：SAME_PERIOD-同期 ![](/core/style/forward.png) ](<index.php?doc-view-1212.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
