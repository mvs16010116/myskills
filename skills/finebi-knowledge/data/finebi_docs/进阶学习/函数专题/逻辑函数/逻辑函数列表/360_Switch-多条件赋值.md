...
title: Switch-多条件赋值
doc_id: 360
url: https://help.fanruan.com/finebi6.X/doc-view-360.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:04:42
---
...
## 2\. 更多示例
当需要判断条件多的时候，使用 [IF 函数](<https://help.fanruan.com/finebi6.0/doc-view-1377.html>) 可能会觉得用要对每种情况都进行判断，比较麻烦，那么可以使用 switch 函数进行多条件赋值。
...
[![](/core/style/back.png)上一篇：OR](<index.php?doc-view-1384.html>)
[下一篇：IF函数的嵌套用法 ![](/core/style/forward.png) ](<index.php?doc-view-2510.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
