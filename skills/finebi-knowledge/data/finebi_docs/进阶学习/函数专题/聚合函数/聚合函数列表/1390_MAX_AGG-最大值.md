...
title: MAX_AGG-最大值
doc_id: 1390
url: https://help.fanruan.com/finebi6.X/doc-view-1390.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:03:03
---
...
### 3.1 计算当前维度下最晚时间
示例数据：[合同事实表.xlsx](<doc-download-/finebi6.X/uploads/file/20250523/合同事实表.xlsx> "下载资料")
你需要计算每月的合同签约最晚时间，如下图所示：  

![](/core/style/lod.png)
添加计算字段「最晚时间」，输入公式：FORMAT(TODATE(MAX_AGG(DATETONUMBER(合同签约时间))),"yyyy-MM-dd HH:mm:ss")，如下图所示：
![Snag_1905579.png](/core/style/lod.png)
公式说明：
公式  
| 说明  
---|---  
...
将「合同签约时间」字段拖入横轴，并设置为按月分组，然后将「最晚时间」也拖入横轴即可，如下图所示：
![Snag_19386bc.png](/core/style/lod.png)
### 附件列表 
  
下载次数：：0
    
**主题：** [进阶学习](<category-view-254>)
[![](/core/style/back.png)上一篇：SUM_AGG-求和](<index.php?doc-view-1385.html>)
[下一篇：MIN_AGG-最小值 ![](/core/style/forward.png) ](<index.php?doc-view-1389.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
