...
title: 对月累计值求年同比
doc_id: 2085
url: https://help.fanruan.com/finebi6.X/doc-view-2085.html
source: FineBI 帮助文档
...
* 历史版本：[10](<edition-list-2085.html>)
...
在线预览：[对月累计求同比](<https://pcdemo.finebi.com/webroot/decision/v5/conf/subject/page/edit/c59c9cbc62ef4f3792eb021906ddc40a/report/f7e667ca4a9940bbbfc3d54e66fc4d77>)
...
![1686588004523231.png](/core/style/lod.png)
3）点击「保存并更新」。
### 2.3 制作组件
...
IF(ISNULL(上一年月累计值),"",月累计值/上一年月累计值-1)| 判断「上一年月累计值」是否为null：若为null，结果显示空值；若不为空，结果显示同比| [IF 条件判断](<https://help.fanruan.com/finebi6.X/doc-view-1377.html>)  
...
[![](/core/style/back.png)上一篇：月盈利天数统计](<index.php?doc-view-2080.html>)
[下一篇：销售额对比分析 ![](/core/style/forward.png) ](<index.php?doc-view-2091.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
