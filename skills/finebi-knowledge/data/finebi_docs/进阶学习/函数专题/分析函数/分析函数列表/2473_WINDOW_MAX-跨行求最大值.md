...
doc_id: 2473
url: https://help.fanruan.com/finebi6.X/doc-view-2473.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:03:17
---

> 1. 概述语法WINDOW_MAX(指标,[分组字段1, 分组字段2.... ],[排序字段1,排序方式,排序字段2, 排序方式...],[窗口上限,窗口下限])返回窗口表达式的最大值window基于分
...
[![](/core/style/back.png)上一篇：WINDOW_SUM-跨行求和/求累计](<index.php?doc-view-2477.html>)
[下一篇：WINDOW_MIN-跨行求最小值 ![](/core/style/forward.png) ](<index.php?doc-view-2474.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
