...
doc_id: 2475
url: https://help.fanruan.com/finebi6.X/doc-view-2475.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:03:19
---

> 1. 概述语法WINDOW_STDEV(指标,[分组字段1, 分组字段2.... ],[排序字段1,排序方式,排序字段2, 排序方式...],[窗口上限,窗口下限])返回窗口表达式的标准差window基
...
[![](/core/style/back.png)上一篇：WINDOW_MIN-跨行求最小值](<index.php?doc-view-2474.html>)
[下一篇：WINDOW_VAR-跨行求方差 ![](/core/style/forward.png) ](<index.php?doc-view-2476.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
