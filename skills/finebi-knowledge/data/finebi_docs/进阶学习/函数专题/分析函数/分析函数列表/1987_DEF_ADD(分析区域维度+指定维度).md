...
doc_id: 1987
url: https://help.fanruan.com/finebi6.X/doc-view-1987.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:03:12
---

> 1. 概述[helpvideo]5520[/helpvideo]1.1 版本FineBI 版本功能变动6.0-6.0.13def_add合计行逻辑优化：合计-自动计算时，使用的是当前合计视图所使用到的拼
...
* 历史版本：[24](<edition-list-1987.html>)
* 最近更新：[April陶](<user-space-431758.html>) 于 2025-02-26 
...
| 公式| 描述  
---|---|---  
分析区域拖入维度字段「省份」![](/core/style/lod.png)  
...
[![](/core/style/back.png)上一篇：DEF(指定维度)](<index.php?doc-view-1986.html>)
[下一篇：DEF_SUB(分析区域维度-指定维度) ![](/core/style/forward.png) ](<index.php?doc-view-1990.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
