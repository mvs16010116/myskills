...
doc_id: 2472
url: https://help.fanruan.com/finebi6.X/doc-view-2472.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:03:16
---

> 1. 概述语法WINDOW_AVG(指标,[分组字段1, 分组字段2.... ],[排序字段1,排序方式,排序字段2, 排序方式...],[窗口上限,窗口下限])返回窗口表达式的平均值window基于分
...
2）更多示例：[求移动平均](<https://help.fanruan.com/finebi6.X/doc-view-2230.html>)
求近三月的移动平均数值。
![2024-08-13_16-17-39.png](/core/style/lod.png)
...
[![](/core/style/back.png)上一篇：WINDOW窗口函数概述-跨行计算](<index.php?doc-view-2470.html>)
[下一篇：WINDOW_SUM-跨行求和/求累计 ![](/core/style/forward.png) ](<index.php?doc-view-2477.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
