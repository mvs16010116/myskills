...
title: 自定义函数简介
doc_id: 13
url: https://help.fanruan.com/finebi6.X/doc-view-13.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:05:07
---
...
### 1.2 使用范围
  * 仅支持抽取数据版本。
  * 不支持自定义聚合类函数，例如：[聚合函数](<https://help.fanruan.com/finebi6.0/doc-view-4.html>)、[快速计算函数](<https://help.fanruan.com/finebi6.0/doc-view-1499.html>) 。
...
详情参见：[自定义函数实现字符串拼接](<https://help.fanruan.com/finebi6.0/doc-view-1244.html>)
## 3\. 注意事项
...
[![](/core/style/back.png)上一篇：求前n天平均值/数据不唯一条件下求平均](<index.php?doc-view-1163.html>)
[下一篇：自定义函数实现字符串拼接 ![](/core/style/forward.png) ](<index.php?doc-view-1244.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
