...
title: AARRR 用户运营分析
doc_id: 1256
url: https://help.fanruan.com/finebi6.X/doc-view-1256.html
source: FineBI 帮助文档
...
所以用户的留存统计也很重要。参考 [留存分析](<https://help.fanruan.com/finebi6.0/doc-view-1119.html?source=4>) 计算激活用户的一周留存率/两周留存率/30天留存率。如下图所示：
...
[![](/core/style/back.png)上一篇：用户流入流出分析](<index.php?doc-view-1273.html>)
[下一篇：用户生命状态分析 ![](/core/style/forward.png) ](<index.php?doc-view-1261.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
