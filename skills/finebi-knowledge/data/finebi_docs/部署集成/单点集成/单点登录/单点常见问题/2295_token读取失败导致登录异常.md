...
doc_id: 2295
url: https://help.fanruan.com/finebi6.X/doc-view-2295.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:11:31
---
...
注：修改 FineDB 数据库表字段值的方法请参考 [FineDB 常用表字段修改](<https://help.fanruan.com/finebi6.X/doc-view-1235.html>)
参数及对应的值说明如下表所示：
参数名  
| 参数值  
---|---  
...
[![](/core/style/back.png)上一篇：单点登录常见问题](<index.php?doc-view-1278.html>)
[下一篇：漏洞声明汇总 ![](/core/style/forward.png) ](<index.php?doc-view-1868.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
