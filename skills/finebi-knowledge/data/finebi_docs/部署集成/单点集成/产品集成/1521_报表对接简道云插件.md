...
title: 报表对接简道云插件
doc_id: 1521
url: https://help.fanruan.com/finebi6.X/doc-view-1521.html
source: FineBI 帮助文档
...
![1632972560767283.png](/core/style/lod.png)
...
![2.png](/core/style/lod.png)](<https://help.fanruan.com/finereport/doc-view-2220.html>)
### 2.2 简道云创建 API Key
...
![1642125662871081.png](/core/style/lod.png)
**原因分析**
FineBI 报表服务器地址不是外网。
**解决方案**
...
![1642125684390267.png](/core/style/lod.png)
**原因分析**
简道云密钥填写错误。  
...
**解决方案**
数据库的编码设置为utf-8。详情请参见：[配置MySQL5外接数据库](<https://help.fanruan.com/finebi6.0/doc-view-1248.html>) 文档的 2.3 节内容。
...
[![](/core/style/back.png)上一篇：FineReport 设计器远程连接 FineBI 工程](<index.php?doc-view-931.html>)
[下一篇：单点登录 ![](/core/style/forward.png) ](<index.php?doc-view-59.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
