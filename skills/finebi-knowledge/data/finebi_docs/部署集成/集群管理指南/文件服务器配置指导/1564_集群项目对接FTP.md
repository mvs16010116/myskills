...
title: 集群项目对接FTP
doc_id: 1564
url: https://help.fanruan.com/finebi6.X/doc-view-1564.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:10:44
---
...
注：FTP传输的数据和命令都是明文的，容易被窃听和篡改。推荐使用更安全的 SFTP 协议 ，详情请参见：[集群项目对接SFTP](<https://help.fanruan.com/finebi6.X/doc-view-1567.html>)
## 2\. 安装FTP
用户需要**自行准备并部署 vsftpd** 。
...
[![](/core/style/back.png)上一篇：FineBI对接腾讯云Redis实现状态服务](<index.php?doc-view-1136.html>)
[下一篇：集群项目对接SFTP ![](/core/style/forward.png) ](<index.php?doc-view-1567.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
