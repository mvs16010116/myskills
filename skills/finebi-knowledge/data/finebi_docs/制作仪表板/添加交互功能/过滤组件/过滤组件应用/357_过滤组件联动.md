...
title: 过滤组件联动
doc_id: 357
url: https://help.fanruan.com/finebi6.X/doc-view-357.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:02:05
---
...
**参数联动：**  
  ...
  * 参数联动适用于带参数的 SQL 数据集。
  * 参数联动仅支持 [直连数据](<https://help.fanruan.com/finebi6.0/doc-view-85.html>) 使用。
...
![5.png](/core/style/lod.png)
### 2.5 取消默认联动
如果不希望两个过滤组件之间默认联动，可以使用 [自定义控制范围](<https://help.fanruan.com/finebi6.0/doc-view-140.html?source=4##7>)，取消组件间的默认联动。
...
[![](/core/style/back.png)上一篇：自定义值列表](<index.php?doc-view-995.html>)
[下一篇：批量导入过滤条件 ![](/core/style/forward.png) ](<index.php?doc-view-461.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
