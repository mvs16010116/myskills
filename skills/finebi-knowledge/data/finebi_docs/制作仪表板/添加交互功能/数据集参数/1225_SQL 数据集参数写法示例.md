...
title: SQL 数据集参数写法示例
doc_id: 1225
url: https://help.fanruan.com/finebi6.X/doc-view-1225.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:02:13
---
...
| 定义| SQL 示例  
---|---|---  
$fine_username| 登录用户的用户名参数| select * from aaa_user where 账号='${fine_username}'参数应用示例：[使用系统参数分配权限](<https://help.fanruan.com/finebi6.X/doc-view-399.html>)  
...
[![](/core/style/back.png)上一篇：仪表板过滤方法](<index.php?doc-view-806.html>)
[下一篇：[直连]日期区间过滤组件传参 ![](/core/style/forward.png) ](<index.php?doc-view-1223.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
