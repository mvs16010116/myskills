...
doc_id: 2436
url: https://help.fanruan.com/finebi6.X/doc-view-2436.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 15:01:50
---

> 1. 概述1.1 版本&nbsp;FineBI 版本插件版本功能变动6.1V1.0.1-1.2 应用场景使用本插件后：web 组件无需再通过链接方式添加 FineReport 模板，可以直接添加目录中已
...
* 历史版本：[4](<edition-list-2436.html>)
* 最近更新：[Lily.Wang](<user-space-337243.html>) 于 2025-04-30 
...
FineBI 插件安装方法参照：[插件管理](<https://help.fanruan.com/finebi6.X/doc-view-459.html>)
## 3\. 操作步骤
...
[![](/core/style/back.png)上一篇：跳转到 FineReport 模板](<index.php?doc-view-1228.html>)
[下一篇：钻取简介 ![](/core/style/forward.png) ](<index.php?doc-view-1630.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
