...
doc_id: 2303
url: https://help.fanruan.com/finebi6.X/doc-view-2303.html
source: FineBI 帮助文档
crawled_at: 2026-07-02 14:59:49
---

> 1. 概述1.1 版本FineBI 版本FineBI JAR 包版本6.0.132023-09-041.2 功能场景安装BI Echarts图表集成插件后，FineBI可以对接Echarts图表，图表组
...
* 最近更新：[小张好像不在线](<user-space-703598.html>) 于 2025-05-20 
...
![](/core/style/lod.png)
注意：使用BI echarts图表集成插件需要一定的echarts图表基础知识  
...
[![](/core/style/back.png)上一篇：热力区域图](<index.php?doc-view-196.html>)
[下一篇：日历图-全年 ![](/core/style/forward.png) ](<index.php?doc-view-1009.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
