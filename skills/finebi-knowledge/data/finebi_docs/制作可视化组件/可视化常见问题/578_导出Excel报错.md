...
title: 导出Excel报错
doc_id: 578
url: https://help.fanruan.com/finebi6.X/doc-view-578.html
source: FineBI 帮助文档
...
进入%Tomcat%/bin目录，找到并编辑配置文件catalina.sh，增加-Djava.awt.headless=true __参数，__ 详情请参见：[导出 Excel 设置](<https://help.fanruan.com/finebi6.0/doc-view-56.html#9>)。
...
[![](/core/style/back.png)上一篇：联动报错](<index.php?doc-view-575.html>)
[下一篇：仪表板不支持的特殊字符 ![](/core/style/forward.png) ](<index.php?doc-view-905.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
