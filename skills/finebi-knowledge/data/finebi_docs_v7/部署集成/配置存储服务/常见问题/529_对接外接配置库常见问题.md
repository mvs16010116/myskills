...
title: 对接外接配置库常见问题
doc_id: 529
url: https://help.fanruan.com/finebi/doc-view-529.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:30:29
version: "7.X"
---

> 1. 概述本文列举FineBI对接&nbsp;配置存储组件&nbsp;时，可能出现的报错和解决方案。2. 数据库迁移后升级 JAR ，无法打开平台问题描述：用户已配置外接数据库，升级 JAR 后，无法打

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 对接外接配置库常见问题
[__](<doc-edit-529.html>)
对此内容反馈
* _
__
...
* 历史版本：[26](<edition-list-529.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2025-09-11 
[](<javascript:;>) [](<javascript:>)
## 1\. 概述
本文列举FineBI对接 [配置存储组件](<https://help.fanruan.com/finebi7.0/doc-view-1080.html>) 时，可能出现的报错和解决方案。
...
详情请参见：[PUT、DELETE请求转成POST插件](<https://help.fanruan.com/finebi7.0/doc-view-1262.html>)
### 附件列表 
  
下载次数：：0
    
**主题：** [部署集成](<category-view-101>)
[![](https://help.fanruan.com/core/style/back.png)上一篇：修改外接配置库账号密码](<index.php?doc-view-1332.html>)
[下一篇：日志存储组件简介 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-706.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
