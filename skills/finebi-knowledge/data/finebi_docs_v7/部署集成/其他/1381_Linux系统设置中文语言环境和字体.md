...
doc_id: 1381
url: https://help.fanruan.com/finebi/doc-view-1381.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:31:07
version: "7.X"
---

> &nbsp;&nbsp;适用对象：本文为第三方解决方案或非产品相关操作指南，仅提供给具备自主开发能力的用户使用。本文仅面向Linux服务器中非运维平台部署的帆软项目。运维平台部署的项目，在工程外挂目录/

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# Linux系统设置中文语言环境和字体
[__](<doc-edit-1381.html>)
对此内容反馈
* _
__
  * 此方案由番薯贡献。  
...
* 历史版本：[11](<edition-list-1381.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2025-12-22 
[](<javascript:;>) [](<javascript:>)
![icon](https://help.fanruan.com/core/style/lod.png) **适用对象：**
**本文为第三方解决方案或非产品相关操作指南，仅提供给具备自主开发能力的用户使用。** 本文仅面向Linux服务器中**非运维平台部署** 的帆软项目。运维平台部署的项目，在**工程外挂目录/customlib/fonts** 文件夹中，可存放客户自定义的字体文件，等同于直接放置在工程的**/usr/share/fonts** 下。请自行查找相关安装包资源，帆软不提供此部分资源。
1）请将字体文件上传到工程外挂目录/customlib/fonts文件夹
2）确保赋予字体文件足够高权限，建议777
3）重启对应工程组件，启动时会进行加载字体文件
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：集群组件出错优化](<index.php?doc-view-1269.html>)
[下一篇：移动端简介 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-335.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
