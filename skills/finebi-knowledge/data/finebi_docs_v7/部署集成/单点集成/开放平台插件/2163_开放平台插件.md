...
title: 开放平台插件
doc_id: 2163
url: https://help.fanruan.com/finebi/doc-view-2163.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:30:43
version: "7.X"
---

> 1. 概述1.1 版本FineBI 版本FineBI JAR 包5.1.102021-02-056.X~7.02022-09-231.2 应用场景客户希望在自身的第三方业务系统中，通过访问应用，调用AP

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 开放平台插件
[__](<doc-edit-2163.html>)
对此内容反馈
* _
__
...
* 历史版本：[16](<edition-list-2163.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2026-06-05 
...
FineBI| [开放平台- FineBI5.0接口插件](<https://market.fanruan.com/plugin/aaa30a2a-d625-45da-a221-d67113659c31>)[开放平台- FineBI6.0接口插件](<https://market.fanruan.com/plugin/67d0a0d2-64a7-4306-b025-d553a2f6d61d>)| [FineBI接口文档](<https://doc.apipost.net/docs/2b091a88a464000>)（7版本沿用6版本相关接口即可）  
...
该认证是方式是通过 access_token 来验证登录信息，access_token 需先通过 应用ID 和密钥获取。
access_token的有效时间为7200s
获取方式如下图所示：
...
整体效果如下图所示：
![730-1435.png](https://help.fanruan.com/core/style/lod.png)
#### 3.3.2 内置的备选认证方式
...
| 说明  
---|---  
国密SM2签名认证| 利用国密SM2椭圆算法进行加解密，对应用ID、密钥以及时间戳进行签名后，通过签名和应用ID进行认证。其中配置项 priKey=密钥、timeout=超时时间（秒）签名_sign_=SM2(应用ID+密钥+时间戳)在 Headers 中添加 _sign_={计算值}，client_id={应用ID}，即可直接访问应用  
摘要签名认证| 在不能使用 token 认证的情况下，可使用摘要演算法（比如 SM3/MD5/ SHA-256），对应用ID、密钥以及时间戳进行签名后，通过签名和应用ID进行认证。  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：产品安全加固指导手册](<index.php?doc-view-2226.html>)
[下一篇：开放平台子插件 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2164.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
