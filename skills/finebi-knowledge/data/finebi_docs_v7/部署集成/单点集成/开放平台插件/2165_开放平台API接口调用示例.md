...
title: 开放平台API接口调用示例
doc_id: 2165
url: https://help.fanruan.com/finebi/doc-view-2165.html
...
模板中写入a、b、c、d4个参数
![](https://help.fanruan.com/core/style/lod.png)
![1111111111111111.PNG](https://help.fanruan.com/core/style/lod.png)
**应用管理：**
在应用管理中，记下“测试”应用的应用ID和密钥两个参数，用于后续步骤中，API调用时的鉴权
**权限管理：**
...
![22222222222222222.PNG](https://help.fanruan.com/core/style/lod.png)
可以看到数据表中增加了1条填报的数据
![](https://help.fanruan.com/core/style/lod.png)
### 示例二：多行数据填报
...
**![2222.PNG](https://help.fanruan.com/core/style/lod.png)**
**应用管理：**
在应用管理中，记下“测试”应用的应用ID和密钥两个参数，用于后续步骤中，API调用时的鉴权
**权限管理：**
在权限管理中，选定应用为“测试”；开启基础数据接口分组中，[demo]填报服务。以保证该API可用
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：开放平台子插件](<index.php?doc-view-2164.html>)
[下一篇：开放平台业务场景示例 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2166.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
