...
doc_id: 931
url: https://help.fanruan.com/finebi/doc-view-931.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:30:55
version: "7.X"
---
...
## 1\. 概述
### 1.1 版本
远程连接需要 FineReport 和 FineBI 版本适配。请参见：[FineBI 与 FineReport 版本适配说明](<https://help.fanruan.com/finebi7.0/doc-view-1061.html>)  

### 1.2 预期效果
当 FineReport 设计器成功远程连接 FineBI ，点击「测试连接」会跳出远程连接成功提示，效果如下图所示：
![1578620310888372.png](https://help.fanruan.com/core/style/lod.png)
### 1.3 实现思路
在 Finereport 设计器上新建工作目录，配置 FineBI 服务器信息之后，测试连接成功，完成配置。
### 1.4 作用范围
使用 Finereport 设计器连接 FineBI 后，只有超级管理员能在 Finereport 设计器中 [创建服务器数据集](<https://help.fanruan.com/finebi7.0/doc-view-253.html>) ，其他用户可以进行 [远程连接](<https://help.fanruan.com/finereport/doc-view-902.html>)，但无法创建服务器数据集，无法对数据连接进行编辑，只能对有权限的数据连接进行使用。
## 2\. 操作步骤
...
![h.png](https://help.fanruan.com/core/style/lod.png)
2）在弹出的「配置工作目录」的界面中，点击+，新建一个远程服务器连接目录，如下图所示：
![1578573358130877.png](https://help.fanruan.com/core/style/lod.png)
### 2.3 配置 FineBI 远程服务器
...
![1578620169197822.png](https://help.fanruan.com/core/style/lod.png)
注：在进行远程连接时，请确保 BI 服务器已经运行。
### 2.3 测试连接
点击「测试连接」可以看到远程连接成功提示。点击「确定」，Finereport 与 BI 的远程连接建立成功。如下图所示：
![1578620310888372.png](https://help.fanruan.com/core/style/lod.png)
注：若提示远程连接失败，请查看日志是否提示没有注册远程设计功能点，具体请参见：[注册管理](<https://help.fanruan.com/finebi7.0/doc-view-177.html>) 文档中远程设计功能点相关内容。
## 3\. 注意事项
### 3.1 SAP BW 插件添加数据集字段显示异常
**问题描述**  

FineReport 设计器 [添加SAP BW数据集](<https://help.fanruan.com/finebi7.0/doc-view-256.html>)，FineReport 环境下数据集展示正常；FineReport 远程连接部署到 Weblogic 的 BI 工程后，添加 SAP BW 数据集，数据列名会部分转换为英文，如下图所示：
![1611884278133495.png](https://help.fanruan.com/core/style/lod.png)
**原因分析**
...
![1611886106260036.png](https://help.fanruan.com/core/style/lod.png)
5）重启 FineBI 。
### 附件列表 
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：FineReport 集成到 FineBI](<index.php?doc-view-67.html>)
[下一篇：报表对接简道云插件 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1521.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
