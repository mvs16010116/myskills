...
title: Ajax 跨域异步单点登录
doc_id: 1070
url: https://help.fanruan.com/finebi/doc-view-1070.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:30:58
version: "7.X"
---
...
注2：内网环境中，下面代码引用的 jquery.min.js 文件无法生效，需下载 JS 文件到本地并修改对应的路径，具体步骤请参见：[单点登录常见问题](<https://help.fanruan.com/finebi7.0/doc-view-1278.html>)。
#### 2.2.1 用户名或密码中无特殊字符
...
![1600841364807511.png](https://help.fanruan.com/core/style/lod.png)
### 2.5 关闭安全防护相关按钮
...
![67.gif](https://help.fanruan.com/core/style/lod.png)
2）在登录成功的浏览器上新开标签页，访问http://localhost:37799/webroot/ajaxlogout.html，点击「登出」按钮，切换到之前登录成功的 8080 工程页面，刷新该页面，用户被踢出登录。如下图所示：
![69.gif](https://help.fanruan.com/core/style/lod.png)
注：如果端口号为 37799 和端口号为 8080 的两个工程都开启 [短信登录验证](<https://help.fanruan.com/finebi7.0/doc-view-743.html#5>) ，访问http://localhost:37799/webroot/ajaxlogin.html时，ajax 单点登录会跳过短信验证直接登录成功。
### 附件列表 
  
下载次数：：0
    
**主题：** [部署集成](<category-view-101>)
[![](https://help.fanruan.com/core/style/back.png)上一篇：前台单点登录接口](<index.php?doc-view-1628.html>)
[下一篇：iframe跨域单点登录 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1224.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
