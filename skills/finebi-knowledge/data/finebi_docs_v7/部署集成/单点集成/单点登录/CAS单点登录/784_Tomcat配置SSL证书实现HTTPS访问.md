...
doc_id: 784
url: https://help.fanruan.com/finebi/doc-view-784.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:31:02
version: "7.X"
---
...
3）保存并关闭web.xml文件。
### 2.5 重启Tomcat
请参考 [关闭或重启FineBI工程](<https://help.fanruan.com/finebi7.0/doc-view-1322.html>) 文档，重启Tomcat服务器，以使配置生效。
### 2.6 效果预览
...
请先使用管理员账号登录数据决策系统，查看「管理系统>系统管理>常规」中是否出现 HTTPS 设置项。
  ...
  * 出现：说明 Websocket 连接未正常配置，请参考文档修改：[HTTPS配置WebSocket](<https://help.fanruan.com/finebi7.0/doc-view-1509.html>)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：CAS单点登录插件](<index.php?doc-view-1071.html>)
[下一篇：SAML单点登录插件 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2702.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
