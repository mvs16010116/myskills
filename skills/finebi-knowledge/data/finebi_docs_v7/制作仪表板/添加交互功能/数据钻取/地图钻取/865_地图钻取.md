...
title: 地图钻取
doc_id: 865
url: https://help.fanruan.com/finebi/doc-view-865.html
...
### 2.1 创建钻取目录
1）使用 「客户维度表」添加组件，创建从省份钻取到城市的客户分布数据，选择维度下的「省份」字段，将其转换为地理角色，详细操作步骤可参考 [维度转化为地理角色](<https://help.fanruan.com/finebi7.0/doc-view-105.html>) 。如下图所示：
...
注：目前 BI 地图中的北京市、上海市、天津市、重庆市、台湾省、香港特别行政区、澳门特别行政区都是算作省份级别的，若需要实现钻取，需要在直辖市和特别行政区下新增区/县的json文件，具体情况参见：[直辖市匹配地理角色(城市)](<https://help.fanruan.com/finebi7.0/doc-view-847.html>)
### 2.2 创建图表
...
![](https://help.fanruan.com/core/style/lod.png)
### 3.2 创建钻取目录
1）使用示例数据[创建分析主题](<https://help.fanruan.com/finebi7.0/doc-view-1889.html>)，选择维度下的「国家」字段，将其转换为地理角色，详细操作步骤可参考 [维度转化为地理角色](<https://help.fanruan.com/finebi7.0/doc-view-105.html>) 。如下图所示：
![4.png](https://help.fanruan.com/core/style/lod.png)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：组件维度切换](<index.php?doc-view-148.html>)
[下一篇：自定义地图钻取 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1081.html>)
