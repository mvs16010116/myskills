...
doc_id: 86
url: https://help.fanruan.com/finebi/doc-view-86.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:21:14
version: "7.X"
---
...
若需要通过过滤组件传递参数，详情参见：[过滤组件作为参数参与计算](<https://help.fanruan.com/finebi7.0/doc-view-974.html>)、[](<https://help.fanruan.com/finebi7.0/doc-view-1228.html#3>)[跳转到仪表板(网页链接)](<https://help.fanruan.com/finebi7.0/doc-view-1594.html>)。
## 2\. 传递一个参数
### 2.1 添加 SQL 数据集
...
#### 2.3.2 预览链接传递参数
获取仪表板预览链接，详情请参见：[预览链接](<https://help.fanruan.com/finebi/doc-view-2765.html>)。仪表板预览的 URL 加上「?参数名称=参数值」，也可以进行参数的传递。
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：[直连]参数为空选择所有值](<index.php?doc-view-397.html>)
[下一篇：[直连]跳转传递参数 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-729.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
