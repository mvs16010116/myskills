...
doc_id: 1194
url: https://help.fanruan.com/finebi/doc-view-1194.html
...
### 1.2 实现思路
在自助数据集中新增一列，使用 IF 或者 [Switch](<https://help.fanruan.com/finebi7.0/doc-view-360.html>)判断不同字段需要跳转的 URL 链接；
在制作仪表板时，使用 [跳转](<https://help.fanruan.com/finebi7.0/doc-view-149.html>) 功能，跳转链接直接选择新增字段即可。
## 2\. 操作步骤
示例数据：「互联网渠道统计数据」  
...
当然也可以使用 [IF](<https://help.fanruan.com/finebi7.0/doc-view-1377.html>) 函数进行条件赋值，如下图所示：
...
注：不支持选择[计算字段](<https://help.fanruan.com/finebi7.0/doc-view-118.html>) 作为跳转字段。
### 2.3 效果查看
#### 2.3.1 PC端  

详情参见本文 1.1 节。
#### 2.3.2 移动端
![1608803053484731.gif](https://help.fanruan.com/core/style/lod.png)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：跳转到仪表板(网页链接)](<index.php?doc-view-1594.html>)
[下一篇：跳转到网页链接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1596.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
