...
title: 导出仪表板FAQ
doc_id: 1904
url: https://help.fanruan.com/finebi/doc-view-1904.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:21:46
version: "7.X"
---
...
Linux 环境中，用户没有开 [模板认证](<https://help.fanruan.com/finebi7.0/doc-view-403.html>) ，超管导出 Excel 时提示：无导出权限，如下图所示：
![9.png](https://help.fanruan.com/core/style/lod.png)
**原因分析**
Linux 下, 处理图片时需要本地的jvm x-server的支持，启动命令需增加选项-Djava.awt.headless=true。
**解决方案**
请参见 [修改 FineBI 配置参数](<https://help.fanruan.com/finebi7.0/doc-view-56.html>) 中的 5.1 节内容。
## 导出加载图片
**问题描述  
**
没加载完全时导出，导出加载状态图片。
...
环境缺少导出参数。
**解决方案**
参考文档配置参数：[Tomcat服务器部署](<https://help.fanruan.com/finebi7.0/doc-view-45.html>)
## 导出表格报错
**问题描述**  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：仪表板变形](<index.php?doc-view-869.html>)
[下一篇：查看图表背后数据的两种方式 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-778.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
