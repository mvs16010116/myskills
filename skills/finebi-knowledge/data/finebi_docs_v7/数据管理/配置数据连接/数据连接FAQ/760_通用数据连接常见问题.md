...
title: 通用数据连接常见问题
doc_id: 760
url: https://help.fanruan.com/finebi/doc-view-760.html
...
### 2.1 检查URL是否正确
参考 [数据连接支持范围](<https://help.fanruan.com/finebi7.0/doc-view-685.html>) ，找到对应数据库正确的 URL 格式，检查数据连接 URL 是否填写正确。如下图所示：  
...
******解决方案 2：** 如果用户实在需要超过限制的数据连接，可以重新注册，提高数据连接数量的限制。详情请参见：[本地机器信息认证](<https://help.fanruan.com/finebi7.0/doc-view-188.html>)
## 4\. 数据连接异常消失
**问题描述：**  
...
将其中一个工程的外接数据库进行迁移，详情请参见：[配置存储组件简介](<https://help.fanruan.com/finebi7.0/doc-view-1080.html>)
## 5\. 未加载到驱动
**问题描述：**
...
对于内网用户，请根据您的数据库和驱动类型，自行选择对应文档，下载并放置驱动：[数据连接](<https://help.fanruan.com/finebi7.0/doc-view-685.html>)
驱动安装完毕后，重新尝试连接即可。
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：购买同步点数](<index.php?doc-view-2550.html>)
[下一篇：MySQL数据连接常见问题 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2117.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
