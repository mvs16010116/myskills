...
doc_id: 2119
url: https://help.fanruan.com/finebi/doc-view-2119.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:14
version: "7.X"
---
...
6.0  
### 1.2 应用场景
本文介绍 [SQL Server数据连接](<https://help.fanruan.com/finebi7.0/doc-view-100.html>) 中，常见的问题及排查步骤。
## 2\. TCP/IP 连接失败
**问题描述：**
...
操作详情请参见： [配置数据连接入门](<https://help.fanruan.com/finebi7.0/doc-view-94.html>)
![](https://help.fanruan.com/core/style/lod.png)
## 4\. SQL SERVER多实例名
**问题描述：**  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：Oracle 数据连接常见错误解决方案](<index.php?doc-view-1100.html>)
[下一篇：DB2数据连接常见问题 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2120.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
