...
doc_id: 290
url: https://help.fanruan.com/finebi/doc-view-290.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:25:53
version: "7.X"
---
...
## 2\. 准备工作
### 2.1 版本和驱动
下载驱动包，并将其上传至 FineBI 中，如何上传详情可参见：[驱动管理](<https://help.fanruan.com/finebi7.0/doc-view-1540.html?source=4>) 2.1 节
支持的数据库版本  
| 驱动包下载  
---|---  
...
## 3\. 具体连接步骤
1）登录 FineBI ，点击「管理系统>数据连接>数据连接管理>新建」，点击「数据连接」，选择「PostgreSQL」，如下图所示：
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：Amazon Redshift数据连接](<index.php?doc-view-292.html>)
[下一篇：南大通用Gbase 8a数据连接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-295.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
