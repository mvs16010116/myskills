---
title: 华为GaussDB 200数据连接
doc_id: 439
url: https://help.fanruan.com/finebi/doc-view-439.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:05
version: "7.X"
---

> 1. 概述1.1 版本FineBI 版本功能变动6.0-1.2 应用场景本文将介绍如何连接 GaussDB 200 数据库。2. 准备工作2.1 版本和驱动版本驱动包下载gaussdb 200postg

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 华为GaussDB 200数据连接
[__](<doc-edit-439.html>)
对此内容反馈
* _
__
...
---|---  
gaussdb 200  
| [postgresql-42.1.4.jar](<doc-download-/finebi5.1/uploads/file/20211227/postgresql-42.1.4.jar> "下载资料")  
### 2.2 收集连接信息
在连接数据库之前，请收集以下信息：
  * 数据库所在服务器的 IP 地址和端口号；
  * 数据库的名称；
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：星环Transwarp Inceptor数据连接](<index.php?doc-view-311.html>)
[下一篇：华为云DWS数据连接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-440.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
