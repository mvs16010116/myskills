...
title: SAP HANA数据连接
doc_id: 306
url: https://help.fanruan.com/finebi/doc-view-306.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:01
version: "7.X"
---

> 1. 概述1.1 版本版本功能变动6.0-1.2 应用场景本文将介绍如何连接 SAP HANA 数据源2. 准备工作2.1 版本和驱动下载驱动，并将其上传至 FineBI，如何上传可参见：驱动管理&nb

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# SAP HANA数据连接
[__](<doc-edit-306.html>)
对此内容反馈
* _
__
...
### 1.2 应用场景
本文将介绍如何连接 SAP HANA 数据源
## 2\. 准备工作
### 2.1 版本和驱动
下载驱动，并将其上传至 FineBI，如何上传可参见：[驱动管理](<https://help.fanruan.com/finebi7.0/doc-view-1540.html>) 2.1 节。
支持的数据库版本| 驱动下载  
---|---  
V1.0 及之后版本| [ngdbc.jar](<doc-download-/uploads/file/20200713/ngdbc.jar> "下载资料")  
### 2.2 收集连接信息
在连接数据库之前，请收集以下信息：  
...
![](https://help.fanruan.com/core/style/lod.png)
注：不支持 Boolean 类型的 null 值，读取到 FineBI 中将显示 false 。
### 附件列表 
  
下载次数：：0
    
**主题：** [数据治理](<category-view-285>)
[![](https://help.fanruan.com/core/style/back.png)上一篇：Presto数据连接](<index.php?doc-view-305.html>)
[下一篇：SAP Sybase数据连接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-307.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
