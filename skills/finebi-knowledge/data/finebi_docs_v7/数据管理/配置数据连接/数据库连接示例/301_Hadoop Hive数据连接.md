...
doc_id: 301
url: https://help.fanruan.com/finebi/doc-view-301.html
...
* 历史版本：[41](<edition-list-301.html>)
* 最近更新：[Wendy123456](<user-space-240644.html>) 于 2026-06-11 
...
（帆软不提供驱动）| [日志jar.rar](<doc-download-/finereport/uploads/file/20211213/日志jar.rar> "下载资料")  
### 2.2 收集连接信息
在连接数据库之前，请收集以下信息：
  * 数据库所在服务器的 IP 地址和端口号；
  * 数据库的名称；
...
Kerberos 认证方式详情可参见：[数据连接 kerberos 认证](<https://help.fanruan.com/finebi7.0/doc-view-282.html>)
![](https://help.fanruan.com/core/style/lod.png)
...
注：若连接失败，可检查是否开启「[安全防护-Token认证增强](<https://help.fanruan.com/finereport/doc-view-2454.html#abf1927b0f24923e>)」，需要关闭。
![](https://help.fanruan.com/core/style/lod.png)
## 4\. 添加数据库的表至FineBI
有两种方式可以将数据库中的表添加至 FineBI ：
  * [添加数据库表](<https://help.fanruan.com/finebi7.0/doc-view-887.html?source=4>)
  * [添加 SQL 数据集](<https://help.fanruan.com/finebi7.0/doc-view-890.html>)


![](https://help.fanruan.com/core/style/lod.png)[](<https://help.fanruan.com/finereport/doc-view-106.html>)
### 附件列表 
  
下载次数：：0
    
**主题：** [数据治理](<category-view-285>)
[![](https://help.fanruan.com/core/style/back.png)上一篇：Doris数据连接](<index.php?doc-view-1688.html>)
[下一篇：Hbase数据连接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-302.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
