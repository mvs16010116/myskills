...
title: Gbase 8S数据连接
doc_id: 296
url: https://help.fanruan.com/finebi/doc-view-296.html
...
## 3\. 具体连接步骤
1）以管理员身份登录数据决策系统，点击「管理系统>数据连接>数据连接管理>新建」，点击「数据连接」，如下图所示：  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：南大通用Gbase 8a数据连接](<index.php?doc-view-295.html>)
[下一篇：Gbase 8T数据连接 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-297.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
