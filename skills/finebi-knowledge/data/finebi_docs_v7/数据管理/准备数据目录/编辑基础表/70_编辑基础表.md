...
title: 编辑基础表
doc_id: 70
url: https://help.fanruan.com/finebi/doc-view-70.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:46
version: "7.X"
---

> 1. 概述1.1 版本FineBI 版本功能变动6.0-7.0.2界面更新，交互效果和显示效果优化1.2 应用场景在添加完基础表后，用户可以对基础表进行一些编辑修改，包括：修改字段类型、给字段排序、自循
...
可以添加「字段设置」后将「日期」拖拽到第五列，再将「产品ID」拖拽到第一列。如下图所示：
![](https://help.fanruan.com/core/style/lod.png)
### 2.5 自循环列和行列转换
抽取数据属性的表可以设置「自循环列」和「行列转换」。  

详情请参见：[自循环列（根据一列分层级）](<https://help.fanruan.com/finebi7.0/doc-view-1132.html>)、[自循环列（根据两列分层级）](<https://help.fanruan.com/finebi7.0/doc-view-71.html>)、[行列转换](<https://help.fanruan.com/finebi7.0/doc-view-75.html>)
### 2.6 保存编辑
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：多路径设置界面](<index.php?doc-view-82.html>)
[下一篇：行列转换之行转列 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-75.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
