...
title: 添加SQL数据集
doc_id: 890
url: https://help.fanruan.com/finebi/doc-view-890.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:24
version: "7.X"
---

> 1. 概述1.1 版本FineBI 版本功能变动7.0-1.2 应用场景用户可以通过简单的 SQL 语句对数据库中的表处理后再添加到「数据目录」中。1.3 功能简介FineBI 中的&nbsp;SQL

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 添加SQL数据集
[__](<doc-edit-890.html>)
对此内容反馈
* _
__
...
7.0| -  
### 1.2 应用场景
用户可以通过简单的 SQL 语句对数据库中的表处理后再添加到「数据目录」中。  

### 1.3 功能简介
FineBI 中的 SQL 语句不能创建新的数据表，也不能修改表结构，仅支持将已有数据库中的表通过 SQL 语句取数至 BI 。
SQL 语句的语法规则需要和连接的数据库适配。
## 2\. 操作步骤
进入「数据目录」，选择一个有管理权限的文件夹（可参见：[公共数据管理权限](<https://help.fanruan.com/finebi7.0/doc-view-249.html>)）。点击「添加表>数据库表」，如下图所示：
...
![](https://help.fanruan.com/core/style/lod.png)
### 2.2 创建有参数的 SQL 数据集
1）输入一句有参数的 SQL 语句（参数的命名规则可参见：[参数命名规则](<https://help.fanruan.com/finebi7.0/doc-view-471.html>)）
2）点击「刷新」
3）对 SQL 中出现的参数设置参数类型和默认值
4）点击「预览」，查看取数结果，即筛选出所有时间大于 2016-12-12 14:15:25 的数据。
注：参数默认值可以设置为空，配合 if 函数或<parameter>实现参数为空时选择所有值的效果，详情可参见 [参数为空选择所有值（直连）](<https://help.fanruan.com/finebi7.0/doc-view-397.html>) 。SQL 数据集支持添加参数后传递使用，详情使用介绍请参见 [URL参数的传递使用（直连）](<https://help.fanruan.com/finebi7.0/doc-view-86.html>) 。
![](https://help.fanruan.com/core/style/lod.png)
...
用户可以使用自检工具，按照 [数据库连接失败排查步骤](<https://help.fanruan.com/finebi7.0/doc-view-760.html>) 2.3 节执行，在要查询的 SQL 语句后输入调用存储过程的语句，如果执行成功，即表明可以在 FineBI 调用存储过程。
![](https://help.fanruan.com/core/style/lod.png)
### 3.2 调用示例
...
也可进入「管理系统>数据连接>数据连接管理」，重新连接数据库并保存，即可通过 [添加数据库表](<https://help.fanruan.com/finebi7.0/doc-view-887.html>) 添加视图。
![](https://help.fanruan.com/core/style/lod.png)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：添加数据库表](<index.php?doc-view-887.html>)
[下一篇：添加Excel数据集 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-891.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
