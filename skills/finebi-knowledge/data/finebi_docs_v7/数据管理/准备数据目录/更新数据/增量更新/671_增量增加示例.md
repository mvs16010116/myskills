...
title: 增量增加示例
doc_id: 671
url: https://help.fanruan.com/finebi/doc-view-671.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:26:30
version: "7.X"
---
...
* 历史版本：[37](<edition-list-671.html>)
* 最近更新：[Lily.Wang](<user-space-337243.html>) 于 2026-05-28 
...
## 2\. 操作步骤
把 MySQL 数据库中的「客户注册信息表」添加到 FineBI ，详细操作请参见：[添加数据库表](<https://help.fanruan.com/finebi7.0/doc-view-887.html>)
...
该 SQL 语句取出「与本公司来往日期」大于「上次更新时间」的数据后，系统会再将数据增加到 FineBI 中，实现增量更新。
...
| 
  ...
  * 可用 ${__last_update_time__} 代替，本示例的 SQL 语句可写为SELECT * FROM 客户注册信息表 where 注册日期 > str_to_date('${__last_update_time__}','%Y-%m-%d %H:%i:%s')  
...
定时更新详细设置方式可参见：[定时更新](<https://help.fanruan.com/finebi7.0/doc-view-89.html>)
## 
### 附件列表 
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：增量更新概述](<index.php?doc-view-92.html>)
[下一篇：增量修改示例 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1663.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
