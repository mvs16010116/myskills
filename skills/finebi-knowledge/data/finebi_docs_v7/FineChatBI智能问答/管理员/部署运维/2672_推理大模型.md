...
title: 推理大模型
doc_id: 2672
url: https://help.fanruan.com/finebi/doc-view-2672.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:25:27
version: "7.X"
---

> 1. 概述1.1 版本版本功能变动FineChatBI支持连接 Azure 云上大模型1.2 应用场景推理大模型用于支撑 FineChatBI 的以下功能：数据解读、归因分析。若资源有限，可以直接使用通

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 推理大模型
[__](<doc-edit-2672.html>)
对此内容反馈
* _
__
...
* 历史版本：[23](<edition-list-2672.html>)
...
云上大模型| DeepSeek-R1/DeepSeek-R1-0528| token 费用 = (N x X + M x Y) x U x V
  ...
  * X：大模型云服务 input token 收费标准，以实际为准，腾讯云价格（¥0.004 / 千Token，[计费说明](<https://cloud.tencent.com/document/product/1772/115963>)）
  * Y：大模型云服务 output token 收费标准，以实际为准，腾讯云价格（¥0.016 / 千Token，[计费说明](<https://cloud.tencent.com/document/product/1772/115963>)）
  * U：月活用户数
  * V：单用户每月深度推理查询（归因分析+深度解读）次数，经验值参考为 5 次
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：通用大模型](<index.php?doc-view-2670.html>)
[下一篇：判断大模型是否满足 FineChatBI 能力要求 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2612.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
