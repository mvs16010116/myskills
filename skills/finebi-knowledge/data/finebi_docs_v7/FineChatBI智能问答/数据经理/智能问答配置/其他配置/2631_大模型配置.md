...
title: 大模型配置
doc_id: 2631
url: https://help.fanruan.com/finebi/doc-view-2631.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:25:20
version: "7.X"
---

> 1. 概述1.1 版本版本功能变动V3.0-V3.19.0新增数据解读配置V3.20.0新增智能扩写配置V3.34.0新增数据结论配置新增追问轮次配置V4.2新增问答模式自定义选择1.2 应用场景大模型

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 大模型配置
[__](<doc-edit-2631.html>)
对此内容反馈
* _
__
...
## 2.大模型服务配置
用户可参考：[FineChatBI 服务架构概述](<https://help.fanruan.com/finebi7.0/doc-view-2583.html>) 部署大模型服务：
...
![1740985796346716.png](https://help.fanruan.com/core/style/lod.png)
### 3.4 数据解读
...
![1741935709413233.gif](https://help.fanruan.com/core/style/lod.png)
### 3.5 归因分析建议
...
![1735011615450226.gif](https://help.fanruan.com/core/style/lod.png)
### 3.6 智能简介
预加载配置中，主题简介可以通过大模型智能扩写。如下图所示：[](<https://help.fanruan.com/finebi7.0/doc-view-2576.html>)
![1743587650890243.gif](https://help.fanruan.com/core/style/lod.png)
### 3.7 追问轮次
管理员可通过「追问轮次」可限制用户的追问轮次，如下图所示：  

详情请参见：[追问](<https://help.fanruan.com/finebi/doc-view-2711.html>)。
![](https://help.fanruan.com/core/style/lod.png)
### 3.8 数据结论
开启数据结论功能后，系统可基于查询出来的图表数据，在生成图表的同时也生成易懂的业务结论与分析结果，同时满足精准查数和深度分析计算。详情请参见：[数据结论](<https://help.fanruan.com/finebi/doc-view-2714.html>)。
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：预处理配置](<index.php?doc-view-2630.html>)
[下一篇：多语言配置 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2683.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
