...
title: WeLink定时推送消息
doc_id: 2069
url: https://help.fanruan.com/finebi/doc-view-2069.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:31:47
version: "7.X"
---
...
## 2\. WeLink 定时推送消息
### 2.1 配置 WeLink 集成
详情参见：[WeLink集成](<https://help.fanruan.com/finebi7.0/doc-view-1797.html>) 。
### 2.2 设置定时调度任务
...
![2021-10-20_18-35-19.png](https://help.fanruan.com/core/style/lod.png)
示例的「客户端通知」设置，选择「WeLink 通知」，消息类型选择「链接消息」。输入主题内容。
注：推送消息类型支持：链接消息（仅支持自定义链接）、图文消息，V11.0.74 及之后版本还支持图片消息。详情请参考：[第三方集成推送支持的消息类型](<https://help.fanruan.com/finebi7.0/doc-view-1186.html>) 。
详情如下图所示：
...
![Screenshot_20211020_185300_com.huawei.welink\(1\).jpg](https://help.fanruan.com/core/style/lod.png)
## 3\. WeLink 定时推送群消息
### 3.1 配置 WeLink 集成
...
![1634713284511903.png](https://help.fanruan.com/core/style/lod.png)
### 3.3 设置定时调度任务
...
2）推送消息类型支持：链接消息（仅支持自定义链接）、图文消息，V11.0.74 及之后版本还支持图片消息。详情请参考：[第三方集成推送支持的消息类型](<https://help.fanruan.com/finebi7.0/doc-view-1186.html>) 。
...
![2021-10-21_13-39-17.png](https://help.fanruan.com/core/style/lod.png)
## 4\. 注意事项
...
不开启「[模板认证](<https://help.fanruan.com/finebi7.0/doc-view-403.html>)」的情况下不需要手动输入账号密码，可直接预览模板；开启后，需手动输入账号密码进入。
2）模板预览链接
如：http://secure.finedevelop.com:55082/webroot/decision/view/report?viewlet=GettingStarted.cpt
不开启「[模板认证](<https://help.fanruan.com/finebi7.0/doc-view-403.html>)」的情况下不需要手动输入账号密码，可直接预览模板；开启后，需手动输入账号密码进入。
3）WeLink 管理生成的链接
详情参见：[WeLink集成](<https://help.fanruan.com/finebi7.0/doc-view-1797.html>) 2.5.2 生成 WeLink 链接 。
支持单点登录。
### 4.2 图文消息
  * 自定义链接  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：WeLink集成](<index.php?doc-view-1797.html>)
[下一篇：已有群消息推送 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2316.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
