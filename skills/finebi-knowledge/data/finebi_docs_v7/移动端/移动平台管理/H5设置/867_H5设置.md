...
title: H5设置
doc_id: 867
url: https://help.fanruan.com/finebi/doc-view-867.html
...
插件安装： [插件管理](<https://help.fanruan.com/finebi7.0/doc-view-459.html>)
### 2.2 界面简介
插件安装完成后，管理员登录FineBI系统，点击「管理系统>移动平台>H5设置」，如下图所示：
![H5设置111.png](https://help.fanruan.com/core/style/lod.png)
## 3\. 底部首页切换
开启「底部首页切换」按钮，用户在 HTML5 端访问 FineBI 工程时，可通过按钮的方式实现首页和目录的切换。
### 3.1 开启底部首页切换按钮
管理员登录FineBI系统，点击「管理系统>移动平台>H5设置」， 开启「底部首页切换」按钮，弹出提示框即设置成功。如下图所示：
![底部首页切换.png](https://help.fanruan.com/core/style/lod.png)
### 3.2 效果预览
HTML5 端输入http://ip:端口号/webroot/decision，访问 FineBI 工程，用户可通过底部实现首页与目录间的切换，效果如下图所示：
注1：HTML5 端访问 FineBI 工程的步骤可参考 [HTML5端访问FineBI](<https://help.fanruan.com/finebi7.0/doc-view-452.html>) 。[](<https://help.fanruan.com/finereport/doc-view-3175.html>)
注2：如未设置首页，无法实现首页与目录之间的切换。具体步骤请参见 [管理首页](<https://help.fanruan.com/finebi7.0/doc-view-245.html>) 。
![2020-09-14_16-05-25.png](https://help.fanruan.com/core/style/lod.png)
## 4\. H5集成登录
...
![H5设置88888.png](https://help.fanruan.com/core/style/lod.png)
具体设置内容和注意事项如下：
设置项| 简介  
---|---  
...
![顶部导航栏.png](https://help.fanruan.com/core/style/lod.png)
具体设置内容如下表所示：
设置项  
| 简介  
---|---  
...
注：HTML5 端访问 FineBI 工程的步骤可参考 [HTML5端访问FineBI](<https://help.fanruan.com/finebi7.0/doc-view-452.html>) 。
![2020-09-14_17-08-40.png](https://help.fanruan.com/core/style/lod.png)
「返回按钮」生效范围如下表所示：
场景  
| 返回按钮  
---|---  
...
详情请参见：[HTML5快速返回目录](<https://help.fanruan.com/finebi7.0/doc-view-644.html>) 。
## 7\. 使用 JSBridge
H5 通过 JSBridge 与原生 App 通信，用户若需要和原生 App 通信，可打开「使用JSBridge」按钮，弹出提示即设置成功。如下图所示：
![JSB.png](https://help.fanruan.com/core/style/lod.png)
## 8\. 设置资源地址
...
### 8.2 示例
具体使用请参见 [设置资源地址](<https://help.fanruan.com/finebi7.0/doc-view-2065.html>) 中第三章、第四章内容。
## 9\. 引入 JS 和 CSS 文件
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：App更新升级提示](<index.php?doc-view-1605.html>)
[下一篇：HTML5设置资源地址 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2065.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
