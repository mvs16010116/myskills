...
title: [HTML5]单点登录
doc_id: 534
url: https://help.fanruan.com/finebi/doc-view-534.html
...
1）Ajax 跨域单点登录
2）iframe 跨域单点登录
注：实现 HTML5 端单点登录，需要先安装 HTML5 移动端展现插件，详情请参见：[HTML5 端访问仪表板/工程](<https://help.fanruan.com/finebi7.0/doc-view-452.html>)
## 2\. AJAX 跨域单点登录
### 2.1 新建 login.html
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：[APP]关于](<index.php?doc-view-1341.html>)
[下一篇：[HTML5]快速返回目录 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-644.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
