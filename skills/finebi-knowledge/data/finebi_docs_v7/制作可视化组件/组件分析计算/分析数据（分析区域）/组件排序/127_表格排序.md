...
title: 表格排序
doc_id: 127
url: https://help.fanruan.com/finebi/doc-view-127.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:19:50
version: "7.X"
---

> 1. 概述1.1 版本版本功能变动7.0-1.2 应用场景用户在制作表格组件时，在 过滤组件&nbsp;过滤结果的基础上，希望数据可以按照某种顺序展示。1.3 功能简介表格排序有两个入口：「分析区域字段

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 表格排序
[__](<doc-edit-127.html>)
对此内容反馈
* _
__
...
### 1.2 应用场景
用户在制作表格组件时，在 [过滤组件](<https://help.fanruan.com/finebi7.0/doc-view-382.html>) 过滤结果的基础上，希望数据可以按照某种顺序展示。
### 1.3 功能简介
...
---|---  
明细表| 不支持维度排序  
[计算字段](<https://help.fanruan.com/finebi7.0/doc-view-118.html>) 不支持表头排序  
所有表格  
...
注：默认排序规则是 UTF-8，UTF-8 汉字是按照康熙字典进行的排序，如果需要汉字按照拼音排序需要开启 [中文排序](<https://help.fanruan.com/finebi7.0/doc-view-312.html#3>) 功能，再重启 BI ，然后重新抽取所有数据，汉字排序如遇见特殊字符会出现报错，请谨慎开启。
![](https://help.fanruan.com/core/style/lod.png)
#### 2.1.2 依赖其他字段排序
1）依赖指标字段排序
...
![1604904702786568.png](https://help.fanruan.com/core/style/lod.png)
拖拽字段设置自定义排序，完成点击「确定」保存。如下图所示：
![排序.gif](https://help.fanruan.com/core/style/lod.png)
...
![交叉表排序.gif](https://help.fanruan.com/core/style/lod.png)
### 3.3 明细表
...
2）重启 BI 后重新更新数据表，详情参见文档：[全局更新](<https://help.fanruan.com/finebi7.0/doc-view-88.html>)
#### 4.1.2 效果查看
...
![1604914597542419.png](https://help.fanruan.com/core/style/lod.png)
### 4.2 null 值排序
null为最小值，升序是排在最前，降序时排在最后。如下图所示：
![1604915675826326.png](https://help.fanruan.com/core/style/lod.png)
### 4.3 自定义排序与过滤组件共同使用
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：排序概述](<index.php?doc-view-1497.html>)
[下一篇：图表排序 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-232.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
