...
title: 表格汇总方式
doc_id: 130
url: https://help.fanruan.com/finebi/doc-view-130.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:19:54
version: "7.X"
---
...
![2024-11-28_13-51-49.png](https://help.fanruan.com/core/style/lod.png)
适用范围：仅分组表和交叉表支持。
注：针对 [计算指标](<https://help.fanruan.com/finebi7.0/doc-view-118.html>) ，先按照计算指标字段设置的汇总方式对指标进行汇总，然后再按照计算指标设置的公式进行计算。 
...
进行设置，将「电池型号」按照维度划分后，计算每种类型电池 95% 百分位位置上的数值，如下图所示：![8.png](https://help.fanruan.com/core/style/lod.png)
## 7\. 标准差
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：设置日期分组和格式](<index.php?doc-view-1654.html>)
[下一篇：图表汇总方式 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-236.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
