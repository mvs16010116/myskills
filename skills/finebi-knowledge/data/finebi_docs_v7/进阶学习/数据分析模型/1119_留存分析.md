...
title: 留存分析
doc_id: 1119
url: https://help.fanruan.com/finebi/doc-view-1119.html
...
### 2.1 新建分析主题
新建分析主题并添加数据集「用户留存分析」。详情请参见[5分钟上手FineBI](<https://help.fanruan.com/finebi7.0/doc-view-818.html>)。
### 2.2 制作组件
点击左下角组件，如下图所示：  

![3.jpg](https://help.fanruan.com/core/style/lod.png)
### 2.3 计算激活用户留存率
注：示例数据已经计算激活_登录时间差，若已有数据未经处理，可使用 [新增列时间差](<https://help.fanruan.com/finebi7.0/doc-view-509.html#5>) 计算。
#### 2.3.1 当日留存率
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：ABC分析(帕累托)](<index.php?doc-view-702.html>)
[下一篇：库存周转分析 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1135.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
