...
title: RFM分析
doc_id: 703
url: https://help.fanruan.com/finebi/doc-view-703.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:24:39
version: "7.X"
---
...
![N1.jpg](https://help.fanruan.com/core/style/lod.png)
仪表板效果如下图所示：
![1606268127560030.png](https://help.fanruan.com/core/style/lod.png)
### 1.4 实现思路
...
### 2.1 创建分析主题
1）新建分析主题并添加数据集「RFM明细数据」。详情请参见[5分钟上手FineBI](<https://help.fanruan.com/finebi7.0/doc-view-818.html>)。  

2）添加数据，点击「字段设置」勾选以下几个字段，点击「保存」并「更新」，如下图所示：  

![N4.jpg](https://help.fanruan.com/core/style/lod.png)
### 2.2 计算客户的消费指标
计算每个客户的平均单次消费金额、消费次数、最后一次消费距今天数。
1）对数据进行分组汇总，如下图所示：
![2024-12-23_18-31-07.png](https://help.fanruan.com/core/style/lod.png)
...
![2024-12-23_18-39-02.png](https://help.fanruan.com/core/style/lod.png)
...
![2024-12-23_18-44-46.png](https://help.fanruan.com/core/style/lod.png)
#### 2.4.2 消费次数评价
...
分组赋值的详细操作可参见：[新增列-分组赋值](<https://help.fanruan.com/finebi7.0/doc-view-1530.html?source=4>)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：月复购率分析](<index.php?doc-view-1264.html>)
[下一篇：波士顿矩阵图 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-733.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
