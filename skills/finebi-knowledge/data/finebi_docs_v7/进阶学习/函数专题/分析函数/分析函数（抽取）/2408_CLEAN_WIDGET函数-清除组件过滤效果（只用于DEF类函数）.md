...
doc_id: 2408
url: https://help.fanruan.com/finebi/doc-view-2408.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:23:20
version: "7.X"
---

> 1. 概述注：本函数仅适用于自助分析主题。[helpvideo]10573[/helpvideo]1.1 版本FineBI版本功能变动6.1-1.2 语法语法CLEAN_WIDGET(字段1,字段2,字

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# CLEAN_WIDGET函数-清除组件过滤效果（只用于DEF类函数）
[__](<doc-edit-2408.html>)
对此内容反馈
* _
__
...
| 正常产生过滤效果| 正常产生过滤效果  
### 3.2 在DEF中的计算逻辑
与 CLEAN 函数逻辑一致。详情参见：[CLEAN函数](<https://help.fanruan.com/finebi7.0/doc-view-2407.html>)
## 4\. 示例 
公式  
| 结果| 备注  
---|---|---  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：CLEAN函数-清除所有过滤效果（只用于DEF类函数）](<index.php?doc-view-2407.html>)
[下一篇：WINDOW窗口函数概述-跨行计算 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2470.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
