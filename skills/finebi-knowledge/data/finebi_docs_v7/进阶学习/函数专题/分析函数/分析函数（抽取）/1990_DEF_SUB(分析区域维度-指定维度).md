...
doc_id: 1990
url: https://help.fanruan.com/finebi/doc-view-1990.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:23:18
version: "7.X"
---

> 1. 概述注：本函数仅适用于自助分析主题。[helpvideo]5520[/helpvideo]1.1 版本&nbsp;FineBI 版本功能变更6.0-6.0.13DEF_SUB 合计行逻辑优化：合计

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# DEF_SUB(分析区域维度-指定维度)
[__](<doc-edit-1990.html>)
对此内容反馈
* _
__
...
* 历史版本：[18](<edition-list-1990.html>)
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：DEF_ADD(分析区域维度+指定维度)](<index.php?doc-view-1987.html>)
[下一篇：EARLIER-获取当前行的值（只用于DEF类函数） ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1991.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
