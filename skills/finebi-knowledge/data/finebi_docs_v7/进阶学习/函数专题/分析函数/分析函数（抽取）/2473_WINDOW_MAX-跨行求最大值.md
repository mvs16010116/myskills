---
title: WINDOW_MAX-跨行求最大值
doc_id: 2473
url: https://help.fanruan.com/finebi/doc-view-2473.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:23:23
version: "7.X"
---

> 1. 概述注：本函数仅适用于自助分析主题。语法WINDOW_MAX(指标,[分组字段1, 分组字段2.... ],[排序字段1,排序方式,排序字段2, 排序方式...],[窗口上限,窗口下限])返回窗口

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# WINDOW_MAX-跨行求最大值
[__](<doc-edit-2473.html>)
对此内容反馈
* _
__
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：WINDOW_SUM-跨行求和/求累计](<index.php?doc-view-2477.html>)
[下一篇：WINDOW_MIN-跨行求最小值 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2474.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
