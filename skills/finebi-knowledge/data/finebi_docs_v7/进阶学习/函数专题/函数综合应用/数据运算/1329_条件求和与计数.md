...
title: 条件求和与计数
doc_id: 1329
url: https://help.fanruan.com/finebi/doc-view-1329.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:24:08
version: "7.X"
---
...
## 2\. 条件计数
### 2.1 在组件中实现
注：若不需要去重统计，只需要记录次数，那么使用 [](<https://help.fanruan.com/finebi7.0/doc-view-4.html#7>)[COUNT_AGG](<https://help.fanruan.com/finebi7.0/doc-view-1386.html>) 计数即可。   
...
[](<https://help.fanruan.com/finebi7.0/doc-view-4.html#13>)[COUNTD_AGG](<https://help.fanruan.com/finebi7.0/doc-view-1388.html>)(IF(DATEDIF(最早激活日期,登录时间,"D")=0,联系电话,null))| 对当日登录用户联系方式进行去重计数  
#### 2.1.2 效果查看
...
### 2.2 在数据中实现
使用 [分组汇总](<https://help.fanruan.com/finebi7.0/doc-view-508.html>) 功能实现去重计数和计数，如下图所示：
...
[](<https://help.fanruan.com/finebi7.0/doc-view-4.html#3>)[SUM_AGG](<https://help.fanruan.com/finebi7.0/doc-view-1385.html>)(IF(省份="北京市"&&客户名称="格双有限公司",回款金额,0))| 对上一步输出的结果进行求和  
### 3.2 效果查看
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：去除字符串里面的某些字符](<index.php?doc-view-820.html>)
[下一篇：指标卡实现展示总计值和最大值 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1513.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
