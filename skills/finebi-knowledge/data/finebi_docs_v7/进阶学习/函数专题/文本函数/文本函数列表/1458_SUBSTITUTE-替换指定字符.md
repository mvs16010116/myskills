...
doc_id: 1458
url: https://help.fanruan.com/finebi/doc-view-1458.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:22:04
version: "7.X"
---
...
参数4| instance_num| 指定位置  
  ...
  * 如果需要替换字段值中指定位置上的任意文本，则使用 [REPLACE-替换指定位置字符](<https://help.fanruan.com/finebi7.0/doc-view-1469.html>) 函数。
...
![2022-08-30_16-12-49.png](https://help.fanruan.com/core/style/lod.png)
更多示例：
公式| 结果| 备注  
---|---|---  
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：TODOUBLE-将文本转换成 Double 对象](<index.php?doc-view-1466.html>)
[下一篇：STARTWITH-判断字符串 str1 是否以 str2 开始 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1477.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
