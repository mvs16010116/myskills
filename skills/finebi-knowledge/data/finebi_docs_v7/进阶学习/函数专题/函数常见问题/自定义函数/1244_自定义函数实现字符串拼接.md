...
title: 自定义函数实现字符串拼接
doc_id: 1244
url: https://help.fanruan.com/finebi/doc-view-1244.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:24:13
version: "7.X"
---
...
* 历史版本：[13](<edition-list-1244.html>)
...
![1612229884767356.png](https://help.fanruan.com/core/style/lod.png)
### 1.2 实现思路
...
注：自定义函数定义规则、注意事项详情参见：[自定义函数简介](<https://help.fanruan.com/finebi7.0/doc-view-13.html>)
### 1.3 函数简介
...
### 2.3 导入 class 文件
**1）请上传class文件至每个bi-engine-worker容器外挂目录/polars/classes文件夹对应路径下**
  * 文件存储位置需要与 java文件里 package 下的位置相对应，classes下如无相关package路径，请自行创建子文件夹
  * 请注意如有多个bi-engine-worker，需要一一上传
  * 本示例将 StringCat.class 文件存放至**每个** bi-engine-worker容器外挂目录/polars/classes/com/fr/function目录下
...
**2）请上传class文件至每个bi-web容器外挂目录/classes文件夹对应路径下**
  ...
  * 本示例将 StringCat.class 文件存放至**每个** bi-web容器外挂目录/classes/com/fr/function目录下


![](https://help.fanruan.com/core/style/lod.png)
  

**3）如该class文件依赖第三方JAR包，请上传对应JAR包至每个bi-engine-worker容器外挂目录/polars/customlib文件夹下**
  * 请注意如有多个bi-engine-worker，需要一一上传
  * 本文示例无需上传
...
使用 [FineReport 设计器远程连接 FineBI 工程](<https://help.fanruan.com/finebi7.0/doc-view-931.html>) ，打开服务器>函数管理器，添加函数并命名为「StringCat」，选择定义好的 StringCat 类，并保存，如下图所示：
![](https://help.fanruan.com/core/style/lod.png)
### 3.3 使用自定义函数
重启 FineBI后便可直接使用，使用方法与内置的函数是相同的。
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：自定义函数简介](<index.php?doc-view-13.html>)
[下一篇：常用函数语法FAQ ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1323.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
