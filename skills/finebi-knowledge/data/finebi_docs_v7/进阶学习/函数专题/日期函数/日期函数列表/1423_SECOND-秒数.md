...
title: SECOND-秒数
doc_id: 1423
url: https://help.fanruan.com/finebi/doc-view-1423.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:22:36
version: "7.X"
---

> 1. 抽取数据1）概述语法SECOND(serial_number,格式)返回某一指定时间的秒数，其值是介于0与59之间的一个整数。参数1serial_number包含所求秒数的时间。&nbsp;参数2

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# SECOND-秒数
[__](<doc-edit-1423.html>)
对此内容反馈
* _
__
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：QUARTER-季度](<index.php?doc-view-1424.html>)
[下一篇：TIME-时间 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1422.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
