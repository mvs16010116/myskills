...
title: 禁止授权权限残缺
doc_id: 1612
url: https://help.fanruan.com/finebi/doc-view-1612.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:28:22
version: "7.X"
---

> 1. 概述1.1 版本BI服务器版本5.1.161.2 应用场景FineBI 授权权限的配置，默认禁止残缺授权。本文将为大家介绍几种防止残缺授权的场景。2. 给角色/用户/非树状部门授权2.1 人员管理

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 禁止授权权限残缺
[__](<doc-edit-1612.html>)
对此内容反馈
* _
__
...
* 历史版本：[1](<edition-list-1612.html>)
* 最近更新：[Carly](<user-space-222366.html>) 于 2021-09-10 
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：层级权限生效逻辑](<index.php?doc-view-1501.html>)
[下一篇：权限复用 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1359.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
