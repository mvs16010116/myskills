...
title: 使用系统参数分配权限
doc_id: 399
url: https://help.fanruan.com/finebi/doc-view-399.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:28:12
version: "7.X"
---
...
除了之前介绍的 [多层级权限需求实现](<https://help.fanruan.com/finebi7.0/doc-view-378.html>) 外，还可以通过添加 FineBI 系统参数实现此场景。
### 1.3 功能简介
...
### 1.4 注意事项
1）系统参数在仪表板分析时，无法对其进行 [过滤组件参数绑定](<https://help.fanruan.com/finebi7.0/doc-view-381.html>)（特殊参数默认隐藏）过滤等操作。
2）本文介绍的参数用法需要使用「[实时数据](<https://help.fanruan.com/finebi7.0/doc-view-85.html>)」，直连数据库的数据表才能使用。
## 2\. 示例
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：行列权限特殊场景](<index.php?doc-view-1019.html>)
[下一篇：数据脱敏 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-2045.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
