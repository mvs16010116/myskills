...
title: 行列权限特殊场景
doc_id: 1019
url: https://help.fanruan.com/finebi/doc-view-1019.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:28:11
version: "7.X"
---
...
![1577781348986999.png](https://help.fanruan.com/core/style/lod.png)
...
![903-1122.png](https://help.fanruan.com/core/style/lod.png)
3）对测试组下的产品线 1 组分配员工信息表的权限，选择 数据权限 Tab 下的「业务包B>员工信息表」
设置行权限为「员工信息表」中的「小组别」字段属于「产品线 1」 。如下图所示：
![903-1128.png](https://help.fanruan.com/core/style/lod.png)
4）对整个开发组分配员工信息表的权限，选择 数据权限 Tab 下的「业务包B>员工信息表」
设置行权限为「员工信息表」中的「部门」字段属于「开发组」。如下图所示：
![903-1134.png](https://help.fanruan.com/core/style/lod.png)
5）对开发组下的产品线 1 分配员工信息表的权限，选择 数据权限 Tab 下的「业务包B>员工信息表」
设置行权限为「员工信息表」中的「小组别」字段属于「产品线 1」 。如下图所示：
![903-1139.png](https://help.fanruan.com/core/style/lod.png)
#### 2.3.2 效果查看
...
超级管理员可通过以下配置项开启/关闭「空即是真」的行权限逻辑，具体操作步骤请参考：[填报修改fine_conf_entity](<https://help.fanruan.com/finebi7.0/doc-view-2157.html>) 。
...
[![](https://help.fanruan.com/core/style/back.png)上一篇：四联表模型示例之多层级权限分配](<index.php?doc-view-2174.html>)
[下一篇：使用系统参数分配权限 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-399.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
