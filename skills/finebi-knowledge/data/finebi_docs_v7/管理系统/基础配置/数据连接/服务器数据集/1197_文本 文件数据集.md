...
title: 文本 文件数据集
doc_id: 1197
url: https://help.fanruan.com/finebi/doc-view-1197.html
source: FineBI 7.X 帮助文档
crawled_at: 2026-07-16 17:28:59
version: "7.X"
---

> 1.概述1.1 版本FineBI 版本JAR 包5.1.92021-01-061.2 应用场景大部分系统生成的 Log 文件都是文本文件，例如网站的浏览访问量，每个页面的停留时间等等。那么 BI 系统对

![](./view/finebi70_2025/images/info_fill.png) 您正在浏览的是 FineBI7.X 帮助文档，点击跳转至： [FineBI6.X帮助文档](<https://help.fanruan.com/finebi6.X/>)
# 文本 文件数据集
[__](<doc-edit-1197.html>)
对此内容反馈
* _
__
...
那么 BI 系统对文本文件的分析就必不可少。用户可以通过服务器数据集导入文本文件作为数据源。
### 1.3 功能简介
...
1）服务器文件：文本文件存储在 BI 工程的%BI_HOME%\webroot\WEB-INF\reportlets目录下。
2）本地文件：文本文件存储在用户电脑上，调用后自动存储至 BI 工程的%BI_HOME%\webroot\WEB-INF\reportlets\txt目录下。
3）远程 URL 文件：文本文件存储在某个服务器端，调用该文件的访问 URL 即可。
### 4.1 服务器文件
将第 2 章准备的文本文件上传至 BI 工程的%BI_HOME%\webroot\WEB-INF\reportlets目录下。如下图所示：
...
![image.png](https://help.fanruan.com/core/style/lod.png)
### 4.2 本地文件
本地文件上传前，需要关闭「管理系统>安全管理>安全防护>文件上传校验」，否则「本地文件」按钮灰化。如下图所示：  
...
![image.png](https://help.fanruan.com/core/style/lod.png)
已上传的文件自动存储至 BI 工程的%BI_HOME%\webroot\WEB-INF\reportlets\txt目录下。如下图所示：
...
**解决方案：**
前往 BI 工程%BI_HOME%\webroot\WEB-INF\reportlets\txt文件夹下找到原同名文件，删除/重命名原同名文件后，重新上传文件即可。
### 附件列表 
  
下载次数：：0
    
**主题：** [管理系统](<category-view-100>)
[![](https://help.fanruan.com/core/style/back.png)上一篇：文件数据集](<index.php?doc-view-1196.html>)
[下一篇：Excel 文件数据集 ![](https://help.fanruan.com/core/style/forward.png) ](<index.php?doc-view-1198.html>)
  * 有帮助
  * 没帮助
  * 只是浏览
